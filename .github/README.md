...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.955.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.955.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-78u8Wjkx0KHx/nqlg6Eu0klg0UzQe2eTz7topRhc+uOTrUShI20sooFh1BGeNghz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.955.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.955.0/index.min.mjs": "sha384-78u8Wjkx0KHx/nqlg6Eu0klg0UzQe2eTz7topRhc+uOTrUShI20sooFh1BGeNghz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.955.0/LICENSE
```

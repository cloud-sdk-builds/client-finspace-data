...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.596.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.596.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uymqNP7Ib3xl4ips+WswVF8XgOu8WGw1QX8SQ/O7I7xTTktNduvXBOBbXz8ymezM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.596.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.596.0/index.min.mjs": "sha384-uymqNP7Ib3xl4ips+WswVF8XgOu8WGw1QX8SQ/O7I7xTTktNduvXBOBbXz8ymezM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.596.0/LICENSE
```

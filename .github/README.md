...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.312.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.312.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HFdhCgGdffy8GU2mBX5fx0lLWZI6zfe7fBh6t+4naBejIL442U6AslUcQ0Um9dVd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.312.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.312.0/index.min.mjs": "sha384-HFdhCgGdffy8GU2mBX5fx0lLWZI6zfe7fBh6t+4naBejIL442U6AslUcQ0Um9dVd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.312.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.872.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.872.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MRxTz9cA+EWemXbfctL0/6F8fKaw3qJYq7mzYq9o/tjDuI6iEOrNSzutA5bltZst
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.872.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.872.0/index.min.mjs": "sha384-MRxTz9cA+EWemXbfctL0/6F8fKaw3qJYq7mzYq9o/tjDuI6iEOrNSzutA5bltZst"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.872.0/LICENSE
```

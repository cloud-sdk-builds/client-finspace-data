...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.749.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.749.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-51JttQb811m2ak0I8dzVeimcu/khp1puDSpzXb0pR6OfGja9vXyTNAyhqs7gxZ6N
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.749.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.749.0/index.min.mjs": "sha384-51JttQb811m2ak0I8dzVeimcu/khp1puDSpzXb0pR6OfGja9vXyTNAyhqs7gxZ6N"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.749.0/LICENSE
```

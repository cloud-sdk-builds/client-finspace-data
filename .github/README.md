...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.620.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.620.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vr0d2gwWNriNA5v2AIsRZ8loVihm+fukLwR9nTAWGVcJI03EEB2SBjgVRFRsryYm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.620.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.620.0/index.min.mjs": "sha384-vr0d2gwWNriNA5v2AIsRZ8loVihm+fukLwR9nTAWGVcJI03EEB2SBjgVRFRsryYm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.620.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.913.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.913.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zEZXpgmOvCxohf8nI8TI1+ggYt6Fm/6XbSZ6oNvHbLePOkZcl4gx59swv5mAiSRN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.913.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.913.0/index.min.mjs": "sha384-zEZXpgmOvCxohf8nI8TI1+ggYt6Fm/6XbSZ6oNvHbLePOkZcl4gx59swv5mAiSRN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.913.0/LICENSE
```

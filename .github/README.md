...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.41.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.41.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8ptz+Fs5hIBwYeK964038dwIcUpcAf4Es/FKCJsJUG3unXAGSIQ7zTTSLxbHzGoq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.41.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.41.0/index.min.mjs": "sha384-8ptz+Fs5hIBwYeK964038dwIcUpcAf4Es/FKCJsJUG3unXAGSIQ7zTTSLxbHzGoq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.41.0/LICENSE
```

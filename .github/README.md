...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.292.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.292.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rlLKa6IzG5cB+Kr/m+09E4xSGOzgCaJV3u7XNJWcj5ubSb4iX9Fq1rXGVMUIg/cy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.292.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.292.0/index.min.mjs": "sha384-rlLKa6IzG5cB+Kr/m+09E4xSGOzgCaJV3u7XNJWcj5ubSb4iX9Fq1rXGVMUIg/cy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.292.0/LICENSE
```

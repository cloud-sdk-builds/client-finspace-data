...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.465.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.465.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-peGXP/idgIw5MfDB0X/cLemTe187blOkFnibcbf6584BMXMXoRsO+dWVw9MVuhLg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.465.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.465.0/index.min.mjs": "sha384-peGXP/idgIw5MfDB0X/cLemTe187blOkFnibcbf6584BMXMXoRsO+dWVw9MVuhLg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.465.0/LICENSE
```

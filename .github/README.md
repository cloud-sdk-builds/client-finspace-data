...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.939.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.939.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MxaR1QriJvI+Knkp+BEkK72qU/1fibVeCucmmB+j0oHCWnrDZMAbdAjhxZgzTndI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.939.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.939.0/index.min.mjs": "sha384-MxaR1QriJvI+Knkp+BEkK72qU/1fibVeCucmmB+j0oHCWnrDZMAbdAjhxZgzTndI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.939.0/LICENSE
```

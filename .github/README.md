...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.835.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.835.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-z7Nh9AuhEkeb9CI9ZIWWVE03QZvX9cAPwvjyaP3MUfiziRGa3rE6lhp8SSVWVUDk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.835.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.835.0/index.min.mjs": "sha384-z7Nh9AuhEkeb9CI9ZIWWVE03QZvX9cAPwvjyaP3MUfiziRGa3rE6lhp8SSVWVUDk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.835.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.1010.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1010.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZydiAjNtUw6x+8RDrcBH8q2VkgqtnKDSeFZKmrG1NO94F8mJe05e3SzJ99dTh/tB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1010.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1010.0/index.min.mjs": "sha384-ZydiAjNtUw6x+8RDrcBH8q2VkgqtnKDSeFZKmrG1NO94F8mJe05e3SzJ99dTh/tB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.1010.0/LICENSE
```

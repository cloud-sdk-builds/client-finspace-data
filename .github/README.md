...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.859.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.859.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HFfhMZCmC0lLwDMrnIZTDcFP4A4MRiZR5Bh9I2pVyaBDN2/UI9hWruOLOd1jBEUz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.859.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.859.0/index.min.mjs": "sha384-HFfhMZCmC0lLwDMrnIZTDcFP4A4MRiZR5Bh9I2pVyaBDN2/UI9hWruOLOd1jBEUz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.859.0/LICENSE
```

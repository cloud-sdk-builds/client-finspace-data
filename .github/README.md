...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.996.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.996.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-L0qt7LUrRRhhEbi5f0C3tlqVG+VlpNZeeViAD/3/QU2te4n5VsbBx8XcxjuNeTCv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.996.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.996.0/index.min.mjs": "sha384-L0qt7LUrRRhhEbi5f0C3tlqVG+VlpNZeeViAD/3/QU2te4n5VsbBx8XcxjuNeTCv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.996.0/LICENSE
```

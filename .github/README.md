...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.972.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.972.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kBYyNnXuPKd6wbWA0ZggX5yDNvWbyOIWDJp1vB1ntQQ0mDzq+csnqIdVVVyU45Dj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.972.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.972.0/index.min.mjs": "sha384-kBYyNnXuPKd6wbWA0ZggX5yDNvWbyOIWDJp1vB1ntQQ0mDzq+csnqIdVVVyU45Dj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.972.0/LICENSE
```

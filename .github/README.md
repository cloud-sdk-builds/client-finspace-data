...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.428.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.428.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WHx8qylwMVOOIit/SVt8oELCgy1XHUTnVEECpaF5JT5dKA+h6FvJODZtoI0KPS/s
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.428.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.428.0/index.min.mjs": "sha384-WHx8qylwMVOOIit/SVt8oELCgy1XHUTnVEECpaF5JT5dKA+h6FvJODZtoI0KPS/s"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.428.0/LICENSE
```

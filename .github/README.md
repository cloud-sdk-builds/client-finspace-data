...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.438.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.438.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-k4MvnIvRfDhQtZf74DU0wUdW9toIl1o8di/5EdqNxcMU9Ht2XGbz2vHvCTGx7Qv3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.438.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.438.0/index.min.mjs": "sha384-k4MvnIvRfDhQtZf74DU0wUdW9toIl1o8di/5EdqNxcMU9Ht2XGbz2vHvCTGx7Qv3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.438.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.218.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.218.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CrmIscB0+p5Hx756qGd1mRfdiXwhe7ct0teofQdOkHnCl2vMJEojJ4IBWAF4sq7G
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.218.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.218.0/index.min.mjs": "sha384-CrmIscB0+p5Hx756qGd1mRfdiXwhe7ct0teofQdOkHnCl2vMJEojJ4IBWAF4sq7G"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.218.0/LICENSE
```

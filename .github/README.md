...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.857.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.857.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wSbgBkpqMimBl4DsoryKzcj/v944GL4uYXppNrqUoBOUajwpxps4C2nE1n8FE0L9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.857.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.857.0/index.min.mjs": "sha384-wSbgBkpqMimBl4DsoryKzcj/v944GL4uYXppNrqUoBOUajwpxps4C2nE1n8FE0L9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.857.0/LICENSE
```

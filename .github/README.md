...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.888.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.888.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZXFtYbLXQFggGh8PlP0gryYlQ6MeAGBq/gBdz2U+UUOsJH9QX9Qn1wwNbKqgwB5A
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.888.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.888.0/index.min.mjs": "sha384-ZXFtYbLXQFggGh8PlP0gryYlQ6MeAGBq/gBdz2U+UUOsJH9QX9Qn1wwNbKqgwB5A"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.888.0/LICENSE
```

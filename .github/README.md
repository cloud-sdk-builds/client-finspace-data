...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.209.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.209.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xB0O+hS6cWlQERM5oaX10lzPJ05MuCbTkclik5YVDJMduwX2cC6Ou0BXVAmmo28W
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.209.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.209.0/index.min.mjs": "sha384-xB0O+hS6cWlQERM5oaX10lzPJ05MuCbTkclik5YVDJMduwX2cC6Ou0BXVAmmo28W"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.209.0/LICENSE
```

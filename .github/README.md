...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.1017.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1017.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xN7++Rq8mTaEL1NhdwtnRp+bhEsruGuIfJQJelfqIOkxB31G/xu0Ih6Djc0HC4hG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1017.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1017.0/index.min.mjs": "sha384-xN7++Rq8mTaEL1NhdwtnRp+bhEsruGuIfJQJelfqIOkxB31G/xu0Ih6Djc0HC4hG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.1017.0/LICENSE
```

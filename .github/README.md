...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.348.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.348.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vjn28P4bJIPEPyNDMISpk5rI8I6UQrLASY7cq0Ez7ufr5JlZ/KMMfsZfwWlH0TvZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.348.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.348.0/index.min.mjs": "sha384-vjn28P4bJIPEPyNDMISpk5rI8I6UQrLASY7cq0Ez7ufr5JlZ/KMMfsZfwWlH0TvZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.348.0/LICENSE
```

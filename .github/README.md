...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.662.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.662.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ezC9kRWb9Ly1+OIEvTy5eEr2QQCH6t7Qpc/yAtttGhEsNuvr0YCxKuWemTFNlysF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.662.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.662.0/index.min.mjs": "sha384-ezC9kRWb9Ly1+OIEvTy5eEr2QQCH6t7Qpc/yAtttGhEsNuvr0YCxKuWemTFNlysF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.662.0/LICENSE
```

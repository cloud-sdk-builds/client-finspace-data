...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.620.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.620.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-OIe75n43pUdjLg4REcMnOq/3oH8/l2y9W4eItrZUd3TvOzs1GNPyLpNZ8jyVyBa3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.620.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.620.1/index.min.mjs": "sha384-OIe75n43pUdjLg4REcMnOq/3oH8/l2y9W4eItrZUd3TvOzs1GNPyLpNZ8jyVyBa3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.620.1/LICENSE
```

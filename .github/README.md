...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.306.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.306.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CUvh1FNJQi/dfmiq5hwoBT5oJDbQHyPEEIzOBr9W4KaoCMRhiLuX7w0+FCXflOrv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.306.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.306.0/index.min.mjs": "sha384-CUvh1FNJQi/dfmiq5hwoBT5oJDbQHyPEEIzOBr9W4KaoCMRhiLuX7w0+FCXflOrv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.306.0/LICENSE
```

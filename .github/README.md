...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.163.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.163.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hKM8nX60Fodyg9Sbu53B24uhABOOE/xyENb1WjR6utD2otnAy4X2tg/GXCGPusyT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.163.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.163.0/index.min.mjs": "sha384-hKM8nX60Fodyg9Sbu53B24uhABOOE/xyENb1WjR6utD2otnAy4X2tg/GXCGPusyT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.163.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.295.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.295.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cgRjKlMi4W3AE9RbmL+1jCL31J+ehUcY3bdoOaHRk5qA56jSBRRvXY97OQDiTRNu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.295.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.295.0/index.min.mjs": "sha384-cgRjKlMi4W3AE9RbmL+1jCL31J+ehUcY3bdoOaHRk5qA56jSBRRvXY97OQDiTRNu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.295.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.327.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.327.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GBm07PR+4MDL61HSwUZD76mK6XJ2ChYo3Ua2CAPtWu/rzRpnuDt2d3rz+2yU05H0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.327.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.327.0/index.min.mjs": "sha384-GBm07PR+4MDL61HSwUZD76mK6XJ2ChYo3Ua2CAPtWu/rzRpnuDt2d3rz+2yU05H0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.327.0/LICENSE
```

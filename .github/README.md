...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.509.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.509.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-O1cC9CdYZEco+WyQcVGv/4mSV5VNusD+R/Us4PWJ21SDiHTnZDFRQyaPmMpgUDBh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.509.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.509.0/index.min.mjs": "sha384-O1cC9CdYZEco+WyQcVGv/4mSV5VNusD+R/Us4PWJ21SDiHTnZDFRQyaPmMpgUDBh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.509.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.925.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.925.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Z/MzlRY/DOFErO6i3uv0zYHpgxfZAEv7HluPrTKoisjOR/QHdMR0GH218MjLw6QT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.925.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.925.0/index.min.mjs": "sha384-Z/MzlRY/DOFErO6i3uv0zYHpgxfZAEv7HluPrTKoisjOR/QHdMR0GH218MjLw6QT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.925.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.714.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.714.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-p0rXh6e9q1MIXeeqhJ+eAy6PXH7C2l5HwLHacI7FHJxPmIvNsp+mPVoaZDK0RvAi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.714.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.714.0/index.min.mjs": "sha384-p0rXh6e9q1MIXeeqhJ+eAy6PXH7C2l5HwLHacI7FHJxPmIvNsp+mPVoaZDK0RvAi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.714.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.899.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.899.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0GU3Bd5tdv+m5ng+EXNydh+nB9UMVLdG213sXpexAKf4cTeBDQMG7hhspbmIxMNF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.899.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.899.0/index.min.mjs": "sha384-0GU3Bd5tdv+m5ng+EXNydh+nB9UMVLdG213sXpexAKf4cTeBDQMG7hhspbmIxMNF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.899.0/LICENSE
```

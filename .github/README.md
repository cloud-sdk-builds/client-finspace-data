...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.908.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.908.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1VhucXLvNEw3NjRTwT9ePZgbz6/ZWqPF/lr00+D25OSQLlA3bYZXTAviUN/xdEtJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.908.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.908.0/index.min.mjs": "sha384-1VhucXLvNEw3NjRTwT9ePZgbz6/ZWqPF/lr00+D25OSQLlA3bYZXTAviUN/xdEtJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.908.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.968.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.968.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-r7IdlumIeLP5IQF0z36d01bofdT3ycerDLsVK3g1MpXWUFFv0by3vm9S4wZpPF8k
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.968.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.968.0/index.min.mjs": "sha384-r7IdlumIeLP5IQF0z36d01bofdT3ycerDLsVK3g1MpXWUFFv0by3vm9S4wZpPF8k"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.968.0/LICENSE
```

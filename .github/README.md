...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.279.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.279.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gVT2sidgUHF25uAX3eBHZlDUZRJ4UjetxnN2rlmmG0cXyOK+12bGluOJfetsGwMC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.279.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.279.0/index.min.mjs": "sha384-gVT2sidgUHF25uAX3eBHZlDUZRJ4UjetxnN2rlmmG0cXyOK+12bGluOJfetsGwMC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.279.0/LICENSE
```

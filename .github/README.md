...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.460.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.460.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-So0ezainppV5cVftBkNSaUhZZTkp52RhRMTtgIeQ/802XE1jSWPrBk3NXQZ+353n
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.460.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.460.0/index.min.mjs": "sha384-So0ezainppV5cVftBkNSaUhZZTkp52RhRMTtgIeQ/802XE1jSWPrBk3NXQZ+353n"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.460.0/LICENSE
```

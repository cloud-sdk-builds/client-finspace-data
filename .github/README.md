...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.287.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.287.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Yora917UxRYOKReK84cFksC8EFAD1PKeBliJurvaB/sssSQS8zqj4OGho4ccr2M4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.287.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.287.0/index.min.mjs": "sha384-Yora917UxRYOKReK84cFksC8EFAD1PKeBliJurvaB/sssSQS8zqj4OGho4ccr2M4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.287.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.238.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.238.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0fge7mXWj13/yAsZmu0QrAHSbWdGXbCYEy4mpEVr6yociKwAcKTX5IX/Kipu94gz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.238.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.238.0/index.min.mjs": "sha384-0fge7mXWj13/yAsZmu0QrAHSbWdGXbCYEy4mpEVr6yociKwAcKTX5IX/Kipu94gz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.238.0/LICENSE
```

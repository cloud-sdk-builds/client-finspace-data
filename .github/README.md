...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.774.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.774.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Xk/JV+wg7royhnoaSlReakwQrivKL3vlyme6Wch0CLB4Rd+TU0aeBbBuBucaZGSB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.774.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.774.0/index.min.mjs": "sha384-Xk/JV+wg7royhnoaSlReakwQrivKL3vlyme6Wch0CLB4Rd+TU0aeBbBuBucaZGSB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.774.0/LICENSE
```

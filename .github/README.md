...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.623.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.623.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MDNLQATWeTgISrjJ2kT2biLrZNs5A4cGizpsY9Ys/oyxQ5R6bSmBno8yAnkqdUUu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.623.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.623.0/index.min.mjs": "sha384-MDNLQATWeTgISrjJ2kT2biLrZNs5A4cGizpsY9Ys/oyxQ5R6bSmBno8yAnkqdUUu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.623.0/LICENSE
```

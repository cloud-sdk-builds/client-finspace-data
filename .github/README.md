...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.709.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.709.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+4CpJd+qnmIk4gWKQW5slY5ekqql1xgh9TB9lgZj1UAWhqX7FO025FOtRtAdC3eA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.709.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.709.0/index.min.mjs": "sha384-+4CpJd+qnmIk4gWKQW5slY5ekqql1xgh9TB9lgZj1UAWhqX7FO025FOtRtAdC3eA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.709.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.1036.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1036.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FM7ZCBi1/tuhban8XF9Z/slEBcr4NHMhStaDO7MwFD/CLQN9kxre1hatldDotFIU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1036.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1036.0/index.min.mjs": "sha384-FM7ZCBi1/tuhban8XF9Z/slEBcr4NHMhStaDO7MwFD/CLQN9kxre1hatldDotFIU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.1036.0/LICENSE
```

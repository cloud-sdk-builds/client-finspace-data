...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.272.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.272.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bk2FNFGzEW9f2FsNzQZf2uerAbH2LekNepq+cwAfMq+1N/Ijt5Fs7KpuGgl5vq6K
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.272.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.272.0/index.min.mjs": "sha384-bk2FNFGzEW9f2FsNzQZf2uerAbH2LekNepq+cwAfMq+1N/Ijt5Fs7KpuGgl5vq6K"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.272.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.504.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.504.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VDY2LbL/TDyF5ZysVkp7aQuH9sJ4921V7e8NBehNZpedtvdoCK+3tM47ff9iz/ZP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.504.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.504.0/index.min.mjs": "sha384-VDY2LbL/TDyF5ZysVkp7aQuH9sJ4921V7e8NBehNZpedtvdoCK+3tM47ff9iz/ZP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.504.0/LICENSE
```

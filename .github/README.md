...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.289.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.289.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-H4TrE1heIIghigHSqcxgb87zlwkoKuw2jbqxQGGbrQe9PjjmOTPMt733N0qYOe/L
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.289.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.289.0/index.min.mjs": "sha384-H4TrE1heIIghigHSqcxgb87zlwkoKuw2jbqxQGGbrQe9PjjmOTPMt733N0qYOe/L"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.289.0/LICENSE
```

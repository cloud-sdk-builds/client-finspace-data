...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.999.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.999.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-scYliCnEJRwJKNwXXFi07Y2LlUJBq/l4aNjsVvQuI0k/Dww7+CdPE5oz6+OD1SX9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.999.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.999.0/index.min.mjs": "sha384-scYliCnEJRwJKNwXXFi07Y2LlUJBq/l4aNjsVvQuI0k/Dww7+CdPE5oz6+OD1SX9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.999.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.474.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.474.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vN2XtK3xel6npyWzTY/rjDFLpiMkhineXQuEwywSr26mNVhQ/DD04hq+kP+G/nhh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.474.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.474.0/index.min.mjs": "sha384-vN2XtK3xel6npyWzTY/rjDFLpiMkhineXQuEwywSr26mNVhQ/DD04hq+kP+G/nhh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.474.0/LICENSE
```

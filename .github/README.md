...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.188.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.188.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ONCb6sivKNSGYhrCVVYurMOdeUct7eguK1uB4mBl+1dOJitxQX1ncWhxhtnUZSKO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.188.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.188.0/index.min.mjs": "sha384-ONCb6sivKNSGYhrCVVYurMOdeUct7eguK1uB4mBl+1dOJitxQX1ncWhxhtnUZSKO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.188.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.319.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.319.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aKNiBBs+1kzUzKLaTjP2J/WHTC2g75XIPWy7VEopH4+iu+8YBkk3k3tYNP9qWtz9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.319.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.319.0/index.min.mjs": "sha384-aKNiBBs+1kzUzKLaTjP2J/WHTC2g75XIPWy7VEopH4+iu+8YBkk3k3tYNP9qWtz9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.319.0/LICENSE
```

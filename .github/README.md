...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.259.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.259.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aDCd0ae1jOdwc8KWGTnEWr4AT3ddA8ios/mFJeqBtnybESNkf+CZfd2fH7m32UGS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.259.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.259.0/index.min.mjs": "sha384-aDCd0ae1jOdwc8KWGTnEWr4AT3ddA8ios/mFJeqBtnybESNkf+CZfd2fH7m32UGS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.259.0/LICENSE
```

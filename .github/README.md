...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.965.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.965.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-17ROTQHJTdOnvsAaxDkvIHjknkW0NqceDXUszy6TtiLi27L9tiqYZ1twb6sh4QK/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.965.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.965.0/index.min.mjs": "sha384-17ROTQHJTdOnvsAaxDkvIHjknkW0NqceDXUszy6TtiLi27L9tiqYZ1twb6sh4QK/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.965.0/LICENSE
```

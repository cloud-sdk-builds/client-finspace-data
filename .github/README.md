...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.758.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.758.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-d3pdZuJWvhQu1bx0VvsJCKf1IfFl5NHPkZbZNvDhLs/J2JkbLOgzj3C6+RLlqWOM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.758.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.758.0/index.min.mjs": "sha384-d3pdZuJWvhQu1bx0VvsJCKf1IfFl5NHPkZbZNvDhLs/J2JkbLOgzj3C6+RLlqWOM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.758.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.503.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.503.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-70grdiWASFd4iLBRqxHxnoBrUEYeB09auSvNpnIjhT3WouCJkgKxeaGM1z5Y+3T5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.503.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.503.1/index.min.mjs": "sha384-70grdiWASFd4iLBRqxHxnoBrUEYeB09auSvNpnIjhT3WouCJkgKxeaGM1z5Y+3T5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.503.1/LICENSE
```

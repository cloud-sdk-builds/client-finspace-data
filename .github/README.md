...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.696.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.696.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-28MIGSS7Tl323c4GCbDHzG5d/EK1y5lePdq41gqAK0jJDbeb2yG8u9tRWVxC7Ull
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.696.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.696.0/index.min.mjs": "sha384-28MIGSS7Tl323c4GCbDHzG5d/EK1y5lePdq41gqAK0jJDbeb2yG8u9tRWVxC7Ull"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.696.0/LICENSE
```

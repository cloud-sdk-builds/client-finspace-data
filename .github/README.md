...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.844.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.844.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bfxxsmV5zsAbIjM99vVTiSGLyhjyAf8YXuY1dZ1oIPpzc8eTYYbsXDIqtGmesemQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.844.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.844.0/index.min.mjs": "sha384-bfxxsmV5zsAbIjM99vVTiSGLyhjyAf8YXuY1dZ1oIPpzc8eTYYbsXDIqtGmesemQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.844.0/LICENSE
```

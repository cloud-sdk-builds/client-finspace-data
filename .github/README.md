...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.651.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.651.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-Gxg5pzHVrRac/eTI9R6XVLEcMsvEM+xx1XgJRkkd43UUW+ZMux5DbeLdTxqY+rGE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.651.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.651.1/index.min.mjs": "sha384-Gxg5pzHVrRac/eTI9R6XVLEcMsvEM+xx1XgJRkkd43UUW+ZMux5DbeLdTxqY+rGE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.651.1/LICENSE
```

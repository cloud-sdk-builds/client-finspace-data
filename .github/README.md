...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.359.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.359.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hdRKmtLQic9JcvwstHSmmx6fe5RM36Z7QKdf0ZSlJ015gvgeR5LjnfstGnaj2x51
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.359.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.359.0/index.min.mjs": "sha384-hdRKmtLQic9JcvwstHSmmx6fe5RM36Z7QKdf0ZSlJ015gvgeR5LjnfstGnaj2x51"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.359.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.49.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.49.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zj0i00v6X2UtCWAo36tGdJsTvudPkODqBG0DVJyqw1jgb29QUoK3ZgpXbv8c0pt+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.49.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.49.0/index.min.mjs": "sha384-zj0i00v6X2UtCWAo36tGdJsTvudPkODqBG0DVJyqw1jgb29QUoK3ZgpXbv8c0pt+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.49.0/LICENSE
```

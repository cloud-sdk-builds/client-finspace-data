...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.1012.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1012.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-eceVq9sf0vMjt1ZmEsVe9cszP20fKmYblPFiebb9RdJL0JGsFBuPOSh5Y3zvFDBq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1012.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1012.0/index.min.mjs": "sha384-eceVq9sf0vMjt1ZmEsVe9cszP20fKmYblPFiebb9RdJL0JGsFBuPOSh5Y3zvFDBq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.1012.0/LICENSE
```

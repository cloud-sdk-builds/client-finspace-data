...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.882.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.882.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jVK4gfsWhiXngysCC3hEBs7MsFRENvxpfbyvzpmp3H8mlO8P5eDooO5aWdxFTNVG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.882.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.882.0/index.min.mjs": "sha384-jVK4gfsWhiXngysCC3hEBs7MsFRENvxpfbyvzpmp3H8mlO8P5eDooO5aWdxFTNVG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.882.0/LICENSE
```

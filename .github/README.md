...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.741.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.741.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-m0K6aeCQeoVyor51c9F0PvJXA6DNS7/qqcvd7u4yzTp3X13ScS5EEdb7f3plnZFV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.741.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.741.0/index.min.mjs": "sha384-m0K6aeCQeoVyor51c9F0PvJXA6DNS7/qqcvd7u4yzTp3X13ScS5EEdb7f3plnZFV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.741.0/LICENSE
```

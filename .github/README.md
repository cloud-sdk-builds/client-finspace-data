...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.798.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.798.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-N9PeOrgCBZ+ofAAHDKw/Uq8HzggiJ0a9IERWfKpEbqPjoACp0IBrFI+01Omu6xfO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.798.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.798.0/index.min.mjs": "sha384-N9PeOrgCBZ+ofAAHDKw/Uq8HzggiJ0a9IERWfKpEbqPjoACp0IBrFI+01Omu6xfO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.798.0/LICENSE
```

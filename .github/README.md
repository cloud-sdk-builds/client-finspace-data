...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.76.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.76.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yJ3BgsSmUfVAKNo+05v+qnQfIweLhOjh0PM0SqV7zmxxxBweB8roI7ZcgHWORY42
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.76.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.76.0/index.min.mjs": "sha384-yJ3BgsSmUfVAKNo+05v+qnQfIweLhOjh0PM0SqV7zmxxxBweB8roI7ZcgHWORY42"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.76.0/LICENSE
```

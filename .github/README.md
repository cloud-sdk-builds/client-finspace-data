...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.100.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.100.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-53dm8dqwVyfGlu3xeub5qcbYH3KrE+VF6msBS5cS7LbxSHaqH3JqDTnj9cgOPa+K
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.100.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.100.0/index.min.mjs": "sha384-53dm8dqwVyfGlu3xeub5qcbYH3KrE+VF6msBS5cS7LbxSHaqH3JqDTnj9cgOPa+K"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.100.0/LICENSE
```

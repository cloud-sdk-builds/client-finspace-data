...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.775.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.775.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4LNl4DdXuFbhml6pafy9tWI/jxIxItBUInUdjM5maC86YtCZA4a9yNETd6bvfx4O
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.775.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.775.0/index.min.mjs": "sha384-4LNl4DdXuFbhml6pafy9tWI/jxIxItBUInUdjM5maC86YtCZA4a9yNETd6bvfx4O"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.775.0/LICENSE
```

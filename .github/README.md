...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.210.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.210.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-u86qIMxZuuIahe+KCEXhbThrCLcEkGeWv9d4JFHqKcwbv3jQoSepGZLFB7y23rB+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.210.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.210.0/index.min.mjs": "sha384-u86qIMxZuuIahe+KCEXhbThrCLcEkGeWv9d4JFHqKcwbv3jQoSepGZLFB7y23rB+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.210.0/LICENSE
```

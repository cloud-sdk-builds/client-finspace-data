...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.27.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.27.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-65KJKy1FQQ/KfEfEecRheSn2YIGUYLprOR2TJUKQyFxH/l8E5YwQwLQWllUPBnwL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.27.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.27.0/index.min.mjs": "sha384-65KJKy1FQQ/KfEfEecRheSn2YIGUYLprOR2TJUKQyFxH/l8E5YwQwLQWllUPBnwL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.27.0/LICENSE
```

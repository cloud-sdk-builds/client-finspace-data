...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.16.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.16.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RdsTGY2PlInwbPzgBkZ7Q3YvsfTaWl687K4/JvgGwMFj88nxCFVWmjge4CE9+D/w
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.16.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.16.0/index.min.mjs": "sha384-RdsTGY2PlInwbPzgBkZ7Q3YvsfTaWl687K4/JvgGwMFj88nxCFVWmjge4CE9+D/w"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.16.0/LICENSE
```

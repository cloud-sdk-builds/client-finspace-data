...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.808.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.808.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hrDJibpb+1Fcj06Ww/7fHtQFPFCVEq/x3XFVlrauNHIXrcS7GrEFrwoapV4Y7NjK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.808.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.808.0/index.min.mjs": "sha384-hrDJibpb+1Fcj06Ww/7fHtQFPFCVEq/x3XFVlrauNHIXrcS7GrEFrwoapV4Y7NjK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.808.0/LICENSE
```

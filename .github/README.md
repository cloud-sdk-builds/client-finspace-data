...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.303.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.303.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yaq+jq8KtAD6ElTxH7kZtAj289RAhZTxEM1IVTGUHcNCjLTqqIrJC0lkTsUY6L6J
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.303.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.303.0/index.min.mjs": "sha384-yaq+jq8KtAD6ElTxH7kZtAj289RAhZTxEM1IVTGUHcNCjLTqqIrJC0lkTsUY6L6J"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.303.0/LICENSE
```

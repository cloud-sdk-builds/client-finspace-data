...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.433.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.433.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9ytRICGpCPKhZ7VyHz4f3r14mFry59DIcVLZrsqUSQRyIt5zBGAcFdCNI2Ck8tM+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.433.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.433.0/index.min.mjs": "sha384-9ytRICGpCPKhZ7VyHz4f3r14mFry59DIcVLZrsqUSQRyIt5zBGAcFdCNI2Ck8tM+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.433.0/LICENSE
```

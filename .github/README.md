...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.37.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.37.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GwGN95GYexu24C6C0n5XKkERho548cy5omg+LjESso8LknzvYeEe/35oZ9JNgDPK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.37.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.37.0/index.min.mjs": "sha384-GwGN95GYexu24C6C0n5XKkERho548cy5omg+LjESso8LknzvYeEe/35oZ9JNgDPK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.37.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.987.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.987.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wH7XNNMjqQVRydxBuhU3iR7qbUOUilry64kNFaznQX7OW7ZPUG35A0vTUo7/kDUF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.987.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.987.0/index.min.mjs": "sha384-wH7XNNMjqQVRydxBuhU3iR7qbUOUilry64kNFaznQX7OW7ZPUG35A0vTUo7/kDUF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.987.0/LICENSE
```

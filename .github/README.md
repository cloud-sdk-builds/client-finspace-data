...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.650.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.650.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rHw38jIcY4EV8SiNLjLrhiRaDaHlTpkYXGP04Bgxp1f8CdlyS2akIb0Q5iYn5d8t
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.650.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.650.0/index.min.mjs": "sha384-rHw38jIcY4EV8SiNLjLrhiRaDaHlTpkYXGP04Bgxp1f8CdlyS2akIb0Q5iYn5d8t"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.650.0/LICENSE
```

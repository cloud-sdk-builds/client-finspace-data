...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.713.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.713.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-T8n8uMVFDb0aGXGybQZZrPNaEYMn1S8yBimmL5nPAJsIbYkEXyeRbpgPcOZBkeAN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.713.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.713.0/index.min.mjs": "sha384-T8n8uMVFDb0aGXGybQZZrPNaEYMn1S8yBimmL5nPAJsIbYkEXyeRbpgPcOZBkeAN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.713.0/LICENSE
```

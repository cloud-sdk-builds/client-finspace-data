...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.1016.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1016.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-u6Z0wuTfAcXL+1VUzaN+/zFX9UU4nKw27mT2LQVxwAXmzBLbcVBoG0x/1+Fb6mQY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1016.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1016.0/index.min.mjs": "sha384-u6Z0wuTfAcXL+1VUzaN+/zFX9UU4nKw27mT2LQVxwAXmzBLbcVBoG0x/1+Fb6mQY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.1016.0/LICENSE
```

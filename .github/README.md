...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.92.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.92.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-s+JUUSSKDPutm4sPIyNGVyxfl2djg3MlsIzl7tzL7tAYPgIvkSc2HY3w0ZXFiOv2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.92.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.92.0/index.min.mjs": "sha384-s+JUUSSKDPutm4sPIyNGVyxfl2djg3MlsIzl7tzL7tAYPgIvkSc2HY3w0ZXFiOv2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.92.0/LICENSE
```

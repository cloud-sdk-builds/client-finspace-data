...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.582.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.582.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SPTc1+Jby/elUEDuMuKi+ZH7XKNYENKL4Ei8eBFZlDpcerdgMb7R4JnAKGi9Tuaw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.582.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.582.0/index.min.mjs": "sha384-SPTc1+Jby/elUEDuMuKi+ZH7XKNYENKL4Ei8eBFZlDpcerdgMb7R4JnAKGi9Tuaw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.582.0/LICENSE
```

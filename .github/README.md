...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.918.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.918.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cQFBMLm6EjBdkLph43/T2sSKsgqGeg7ITfF6wQV/nykifVJD+uD0pzRU5+RFRnen
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.918.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.918.0/index.min.mjs": "sha384-cQFBMLm6EjBdkLph43/T2sSKsgqGeg7ITfF6wQV/nykifVJD+uD0pzRU5+RFRnen"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.918.0/LICENSE
```

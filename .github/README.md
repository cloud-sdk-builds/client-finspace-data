...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.256.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.256.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Ke7IWkZ4SFEPosob50vfzUsV/n4FmgvtdcHexi1mR/s/6GwpSSCmld5UkA6TS9V8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.256.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.256.0/index.min.mjs": "sha384-Ke7IWkZ4SFEPosob50vfzUsV/n4FmgvtdcHexi1mR/s/6GwpSSCmld5UkA6TS9V8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.256.0/LICENSE
```

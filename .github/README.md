...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.382.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.382.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-B2ln0GtZetJj72E2t79TBNFztjChBNr/mVrQmBmUas+2Xupkv8OKStk/5ASkGGZA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.382.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.382.0/index.min.mjs": "sha384-B2ln0GtZetJj72E2t79TBNFztjChBNr/mVrQmBmUas+2Xupkv8OKStk/5ASkGGZA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.382.0/LICENSE
```

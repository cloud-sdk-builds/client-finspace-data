...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.906.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.906.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mwNKrrrM2xuJPpGTvZ70p17JAuVDpWIXmZ0Wd4vjtsiYgWo03m/VG63XPCr3TOyP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.906.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.906.0/index.min.mjs": "sha384-mwNKrrrM2xuJPpGTvZ70p17JAuVDpWIXmZ0Wd4vjtsiYgWo03m/VG63XPCr3TOyP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.906.0/LICENSE
```

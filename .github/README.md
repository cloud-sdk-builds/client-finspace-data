...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.917.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.917.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1Z4laG4yK3wzM1IhW8yE7ZuQWK2p1H4Er8Lw0pYn2DlZjisGq9+vbjynE6/rH1Cm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.917.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.917.0/index.min.mjs": "sha384-1Z4laG4yK3wzM1IhW8yE7ZuQWK2p1H4Er8Lw0pYn2DlZjisGq9+vbjynE6/rH1Cm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.917.0/LICENSE
```

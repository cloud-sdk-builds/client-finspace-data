...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.910.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.910.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FmyZz5/Gs+Cxnkyl2aMt2ygy/ZoBglTvisKvBGLe94qM1p9tVZhY0Xfgm1s0TEGf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.910.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.910.0/index.min.mjs": "sha384-FmyZz5/Gs+Cxnkyl2aMt2ygy/ZoBglTvisKvBGLe94qM1p9tVZhY0Xfgm1s0TEGf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.910.0/LICENSE
```

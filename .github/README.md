...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.985.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.985.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+EohKGjTzErK2vntqgBPIw4lNHmv2vNuKE3A3O9i8SxxfqBx8KP+EQX2DGlEQHwZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.985.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.985.0/index.min.mjs": "sha384-+EohKGjTzErK2vntqgBPIw4lNHmv2vNuKE3A3O9i8SxxfqBx8KP+EQX2DGlEQHwZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.985.0/LICENSE
```

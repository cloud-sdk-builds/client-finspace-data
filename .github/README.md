...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.887.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.887.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MW7ArUHQnB/ynyJ3pTKndEGhIDuTU62lXGR8Mnt74rT0e3x8FWWu4lubuw5jQFeT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.887.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.887.0/index.min.mjs": "sha384-MW7ArUHQnB/ynyJ3pTKndEGhIDuTU62lXGR8Mnt74rT0e3x8FWWu4lubuw5jQFeT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.887.0/LICENSE
```

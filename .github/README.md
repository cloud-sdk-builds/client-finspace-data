...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.216.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.216.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wWe0yZ4lZVsRRPp1n8+5LyarKV9Swi+Q2u9ePjOmU+TNklkeQP6LjHjw9sZ0OlfA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.216.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.216.0/index.min.mjs": "sha384-wWe0yZ4lZVsRRPp1n8+5LyarKV9Swi+Q2u9ePjOmU+TNklkeQP6LjHjw9sZ0OlfA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.216.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.257.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.257.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QPL7rgPE+U2molQi/I8DA4pqh0zp1evs4pJGZAKC3unCPfxwsIWH+e5VF2WqOltd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.257.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.257.0/index.min.mjs": "sha384-QPL7rgPE+U2molQi/I8DA4pqh0zp1evs4pJGZAKC3unCPfxwsIWH+e5VF2WqOltd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.257.0/LICENSE
```

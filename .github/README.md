...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.387.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.387.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jveg7JnlvGnsD56uGgmelZD36Tk7NMtJdqXJ1W3HZTEo7DOJdyu2Moh0AGDFRTFE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.387.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.387.0/index.min.mjs": "sha384-jveg7JnlvGnsD56uGgmelZD36Tk7NMtJdqXJ1W3HZTEo7DOJdyu2Moh0AGDFRTFE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.387.0/LICENSE
```

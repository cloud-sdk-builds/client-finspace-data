...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.675.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.675.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fMpvQsfZ4vIRulHHiOJn7FfKiIgn7Bfozh4lUZOH28nlRm3P6YYjUfjPvN04aCeK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.675.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.675.0/index.min.mjs": "sha384-fMpvQsfZ4vIRulHHiOJn7FfKiIgn7Bfozh4lUZOH28nlRm3P6YYjUfjPvN04aCeK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.675.0/LICENSE
```

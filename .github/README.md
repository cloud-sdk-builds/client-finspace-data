...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.1020.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1020.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-S/z2LZED9A8CcVzrflAY8snHCc5mtvHi5FHuCJ/Me6az7p85Bw/+aEkvJqsUXWrg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1020.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1020.0/index.min.mjs": "sha384-S/z2LZED9A8CcVzrflAY8snHCc5mtvHi5FHuCJ/Me6az7p85Bw/+aEkvJqsUXWrg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.1020.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.933.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.933.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JesgoqtPnX5alVukwaLiVzwz8T/WUgMkoqwJQQ0rr5eZ8qegT+f9zrJ21XYRwyXH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.933.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.933.0/index.min.mjs": "sha384-JesgoqtPnX5alVukwaLiVzwz8T/WUgMkoqwJQQ0rr5eZ8qegT+f9zrJ21XYRwyXH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.933.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.890.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.890.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lfvIrQqMWumYmj9aP1cp+orM7zWEGab3hq28t/0Lk6N5LYeigQFBUeMZm/cc2b2v
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.890.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.890.0/index.min.mjs": "sha384-lfvIrQqMWumYmj9aP1cp+orM7zWEGab3hq28t/0Lk6N5LYeigQFBUeMZm/cc2b2v"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.890.0/LICENSE
```

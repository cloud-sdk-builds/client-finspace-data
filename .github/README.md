...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.425.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.425.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3NMcaFi5Zgtogu6CNx3QXbhyU2Do5XvvQj14RpFhcMcrC6fk/hEUFDJ4sGUungFx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.425.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.425.0/index.min.mjs": "sha384-3NMcaFi5Zgtogu6CNx3QXbhyU2Do5XvvQj14RpFhcMcrC6fk/hEUFDJ4sGUungFx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.425.0/LICENSE
```

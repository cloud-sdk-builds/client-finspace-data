...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.507.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.507.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-e8QxwES0KDeyPLlUFpAh1PXIMimotPaZ38FkaPXE2swhMQKC0AG3goSJGKxVcOJS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.507.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.507.0/index.min.mjs": "sha384-e8QxwES0KDeyPLlUFpAh1PXIMimotPaZ38FkaPXE2swhMQKC0AG3goSJGKxVcOJS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.507.0/LICENSE
```

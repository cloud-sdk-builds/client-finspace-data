...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.1024.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1024.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jW2F5E+gGv76WQsF6v6rqKXgl2VF+FAszVWDYfqHQnpearzP6W56bYOqM7RKuWW2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1024.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1024.0/index.min.mjs": "sha384-jW2F5E+gGv76WQsF6v6rqKXgl2VF+FAszVWDYfqHQnpearzP6W56bYOqM7RKuWW2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.1024.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.461.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.461.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+MF8Wp7Z+YrYOHEanHHz4NOUd0oMeXQHF1Dut3g9P2Oheq+PoXJb/sJhQDlRe4fT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.461.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.461.0/index.min.mjs": "sha384-+MF8Wp7Z+YrYOHEanHHz4NOUd0oMeXQHF1Dut3g9P2Oheq+PoXJb/sJhQDlRe4fT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.461.0/LICENSE
```

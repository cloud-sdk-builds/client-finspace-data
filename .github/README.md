...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.329.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.329.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-EkV93LyyvMG9R7hdVDSiJld6bDCd9cTMxdCrmf+LbYqTrIcxn96ZpAG4eSSy9Vzf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.329.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.329.0/index.min.mjs": "sha384-EkV93LyyvMG9R7hdVDSiJld6bDCd9cTMxdCrmf+LbYqTrIcxn96ZpAG4eSSy9Vzf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.329.0/LICENSE
```

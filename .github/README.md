...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.958.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.958.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dgDfSfBYJF+X4Bs3+ID+K4tenlWXbsRSY/RnCbJvV6mpqswa325rxOmVnlI2gqgx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.958.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.958.0/index.min.mjs": "sha384-dgDfSfBYJF+X4Bs3+ID+K4tenlWXbsRSY/RnCbJvV6mpqswa325rxOmVnlI2gqgx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.958.0/LICENSE
```

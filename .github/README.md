...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.988.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.988.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4f6EjLx+6yPSksYrACNwO7harn0kEQHuyaSDS3kNy5IyMgv8C01xJm7m0yYNiCYg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.988.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.988.0/index.min.mjs": "sha384-4f6EjLx+6yPSksYrACNwO7harn0kEQHuyaSDS3kNy5IyMgv8C01xJm7m0yYNiCYg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.988.0/LICENSE
```

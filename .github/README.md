...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.1014.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1014.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RJU/2VT7/yHPAAn0C4MjUDsn23+F6ehxFFWn72kQRoTgpaTAPCdQ8fI/hLTgeQqK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1014.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1014.0/index.min.mjs": "sha384-RJU/2VT7/yHPAAn0C4MjUDsn23+F6ehxFFWn72kQRoTgpaTAPCdQ8fI/hLTgeQqK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.1014.0/LICENSE
```

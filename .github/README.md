...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.441.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.441.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3p/WOuW5siOL/TX45H2oMFev3JS3HRZ8p4wz1FbbcUyG5Y0KFGRNfc4mC2m0HPan
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.441.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.441.0/index.min.mjs": "sha384-3p/WOuW5siOL/TX45H2oMFev3JS3HRZ8p4wz1FbbcUyG5Y0KFGRNfc4mC2m0HPan"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.441.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.127.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.127.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vY36/eHWZuPgav3cGG1595jGggrb6kMZhm0KIchLh+XgecrVYUhmdOmNApxQXpq1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.127.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.127.0/index.min.mjs": "sha384-vY36/eHWZuPgav3cGG1595jGggrb6kMZhm0KIchLh+XgecrVYUhmdOmNApxQXpq1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.127.0/LICENSE
```

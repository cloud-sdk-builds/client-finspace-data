...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.181.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.181.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-crL1w9s/4c7PFwdsD19l5KClT90WqMGNeU54bBnCzljITzxTAvd8joq6TXbmLsCt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.181.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.181.0/index.min.mjs": "sha384-crL1w9s/4c7PFwdsD19l5KClT90WqMGNeU54bBnCzljITzxTAvd8joq6TXbmLsCt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.181.0/LICENSE
```

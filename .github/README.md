...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.744.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.744.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Y633drGxX4wHgJwkOxCUIzto197QU5OWch53S0QR2WJzqlP6ggCJyVv5/JG1/e6a
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.744.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.744.0/index.min.mjs": "sha384-Y633drGxX4wHgJwkOxCUIzto197QU5OWch53S0QR2WJzqlP6ggCJyVv5/JG1/e6a"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.744.0/LICENSE
```

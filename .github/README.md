...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.502.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.502.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-jE/M2KnIDZ/dG6fttNJUQn98lssl3mP7Dh+Dd79tu31+wOxATn6mZC4WsD5SMQKy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.502.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.502.0/index.min.mjs": "sha384-jE/M2KnIDZ/dG6fttNJUQn98lssl3mP7Dh+Dd79tu31+wOxATn6mZC4WsD5SMQKy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.502.0/LICENSE
```

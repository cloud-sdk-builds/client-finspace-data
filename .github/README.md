...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.928.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.928.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4sH5aOrrsZ4CvfQZp5POkqIi8O05KGo+sZrnDm+HXVZBMuHcIeYcWT7TYdK0gmAb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.928.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.928.0/index.min.mjs": "sha384-4sH5aOrrsZ4CvfQZp5POkqIi8O05KGo+sZrnDm+HXVZBMuHcIeYcWT7TYdK0gmAb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.928.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.687.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.687.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UfgDKiNWYNNaRcPf4lmhVOujDy7dDx2QGAv5biBQMF0lPzEo/Dkl3po6/MSYCJ9N
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.687.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.687.0/index.min.mjs": "sha384-UfgDKiNWYNNaRcPf4lmhVOujDy7dDx2QGAv5biBQMF0lPzEo/Dkl3po6/MSYCJ9N"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.687.0/LICENSE
```

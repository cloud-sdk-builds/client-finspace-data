...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.797.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.797.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1gQ88BpGD3fP2JwiSO6Xyna1Wp1qPUrwGuxEmEyf0s0p4JCmyVqMLYlOqlKOnxIY
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.797.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.797.0/index.min.mjs": "sha384-1gQ88BpGD3fP2JwiSO6Xyna1Wp1qPUrwGuxEmEyf0s0p4JCmyVqMLYlOqlKOnxIY"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.797.0/LICENSE
```

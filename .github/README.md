...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.321.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.321.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-q8BO4KD56VxcvNltcLXWo352yi9+k3kg3UR10+W3vFPBnWAoCzeP+eJm4GFZV6XZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.321.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.321.1/index.min.mjs": "sha384-q8BO4KD56VxcvNltcLXWo352yi9+k3kg3UR10+W3vFPBnWAoCzeP+eJm4GFZV6XZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.321.1/LICENSE
```

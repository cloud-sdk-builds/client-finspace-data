...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.410.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.410.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MPT73U+Uv84BmWUoZTV8cCBQe6zx1IycCjju6jam63q4yEbI4dLF+jxFtktH9VAQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.410.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.410.0/index.min.mjs": "sha384-MPT73U+Uv84BmWUoZTV8cCBQe6zx1IycCjju6jam63q4yEbI4dLF+jxFtktH9VAQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.410.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.503.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.503.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dLS2mBJQPVu7oHzqB4aaJos8srQHibpXFdWsojoJ91DkvpqdVovLJE0Bigy05iGr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.503.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.503.0/index.min.mjs": "sha384-dLS2mBJQPVu7oHzqB4aaJos8srQHibpXFdWsojoJ91DkvpqdVovLJE0Bigy05iGr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.503.0/LICENSE
```

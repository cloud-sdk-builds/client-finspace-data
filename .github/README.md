...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.699.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.699.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lLXS9jX0Uk0AcBjh2b2DMsV34NESpXPKC4RzjoKBBJNMyhJIUwBQ2FR5X0H+b7Oq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.699.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.699.0/index.min.mjs": "sha384-lLXS9jX0Uk0AcBjh2b2DMsV34NESpXPKC4RzjoKBBJNMyhJIUwBQ2FR5X0H+b7Oq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.699.0/LICENSE
```

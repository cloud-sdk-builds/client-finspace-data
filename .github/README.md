...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.258.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.258.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bRWjizNoxLx1AkrG2Voz7sAerZhP+eEO1wKQIwhMqDbf7VTnl3Y6J1y1VkfgGbA5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.258.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.258.0/index.min.mjs": "sha384-bRWjizNoxLx1AkrG2Voz7sAerZhP+eEO1wKQIwhMqDbf7VTnl3Y6J1y1VkfgGbA5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.258.0/LICENSE
```

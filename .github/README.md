...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.927.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.927.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-b9+y9IC/0q+J7WOQZ0Lrj4qF93ifDBQ0TU/pZAziGPj0FDskxcJZVSfZOxL8E5wA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.927.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.927.0/index.min.mjs": "sha384-b9+y9IC/0q+J7WOQZ0Lrj4qF93ifDBQ0TU/pZAziGPj0FDskxcJZVSfZOxL8E5wA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.927.0/LICENSE
```

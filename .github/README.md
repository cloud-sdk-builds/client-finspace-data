...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.290.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.290.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Gxv5S2W4zzbsn7+pgO2ebwTl3MRM1yMus1dw9O/uPMnKcsiEMPVKJXYDo2+MxG2Q
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.290.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.290.0/index.min.mjs": "sha384-Gxv5S2W4zzbsn7+pgO2ebwTl3MRM1yMus1dw9O/uPMnKcsiEMPVKJXYDo2+MxG2Q"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.290.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.830.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.830.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WVoNBEMmVa6utijkD8D/+RpYEks5HU7qJfsqvUlySV4G74i1E0hSyq4kblv+HHMw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.830.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.830.0/index.min.mjs": "sha384-WVoNBEMmVa6utijkD8D/+RpYEks5HU7qJfsqvUlySV4G74i1E0hSyq4kblv+HHMw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.830.0/LICENSE
```

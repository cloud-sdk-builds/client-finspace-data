...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.18.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.18.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-utNKTKS9eczgTEAkHtn61aymcyqIC5nSzN6nsUDDub5RzAHbPJt0qLlGI4BjNfdE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.18.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.18.0/index.min.mjs": "sha384-utNKTKS9eczgTEAkHtn61aymcyqIC5nSzN6nsUDDub5RzAHbPJt0qLlGI4BjNfdE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.18.0/LICENSE
```

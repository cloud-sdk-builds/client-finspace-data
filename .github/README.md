...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.1013.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1013.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Q6a1b/5sfRT9E6W5YuXDdYCQAeoFM690BVpOHXPbo3/GuevoUhH7PDLaBoZKmThs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1013.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1013.0/index.min.mjs": "sha384-Q6a1b/5sfRT9E6W5YuXDdYCQAeoFM690BVpOHXPbo3/GuevoUhH7PDLaBoZKmThs"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.1013.0/LICENSE
```

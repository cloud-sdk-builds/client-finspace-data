...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.47.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.47.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-PjBla+EON7dXpzlD6Cv4KVUXAa77dsZTEFRS6PRfMS3F29Whd20mpBgJdYbQMS8d
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.47.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.47.1/index.min.mjs": "sha384-PjBla+EON7dXpzlD6Cv4KVUXAa77dsZTEFRS6PRfMS3F29Whd20mpBgJdYbQMS8d"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.47.1/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.816.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.816.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wldBxnGlwY114wvlXPWqdMRNiuF5nqM4taZ3RGoqz4PDjHpqMqYsbLIX5ZHkyjeb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.816.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.816.0/index.min.mjs": "sha384-wldBxnGlwY114wvlXPWqdMRNiuF5nqM4taZ3RGoqz4PDjHpqMqYsbLIX5ZHkyjeb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.816.0/LICENSE
```

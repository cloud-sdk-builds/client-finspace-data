...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.980.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.980.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-99y37+nZCFQoAgw1dFSe2SZwhtnOTgGiKg8y80XpXrR3wDyhPZ79Do018Puc4qkn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.980.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.980.0/index.min.mjs": "sha384-99y37+nZCFQoAgw1dFSe2SZwhtnOTgGiKg8y80XpXrR3wDyhPZ79Do018Puc4qkn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.980.0/LICENSE
```

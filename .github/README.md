...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.297.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.297.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PiwECav7jeLKZRcI83fYhQC4Z76x75vH5wABtBfjpD+HRFeNrn+pbsHtxftuR7l5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.297.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.297.0/index.min.mjs": "sha384-PiwECav7jeLKZRcI83fYhQC4Z76x75vH5wABtBfjpD+HRFeNrn+pbsHtxftuR7l5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.297.0/LICENSE
```

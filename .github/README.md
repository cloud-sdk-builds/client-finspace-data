...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.907.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.907.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MJ/KqN1a5uMhZ+Q/GLELjGUEGnFgy7Q/RrE01cGLB53alv85OxUBZ24VD++HVdh2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.907.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.907.0/index.min.mjs": "sha384-MJ/KqN1a5uMhZ+Q/GLELjGUEGnFgy7Q/RrE01cGLB53alv85OxUBZ24VD++HVdh2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.907.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.325.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.325.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-geouqlu+LHPVedL+/kTpXAUpNpMAKn/ctbw/sveBNF2Is/9H3vanB/nMe76r65b3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.325.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.325.0/index.min.mjs": "sha384-geouqlu+LHPVedL+/kTpXAUpNpMAKn/ctbw/sveBNF2Is/9H3vanB/nMe76r65b3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.325.0/LICENSE
```

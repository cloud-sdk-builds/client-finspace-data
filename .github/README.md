...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.379.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.379.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-+Qj2JfFXAIr2zs4U2vqP6ZrEglf3yk9yedrx24IANSH5R8H1urooaWM7zdhbCPhl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.379.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.379.1/index.min.mjs": "sha384-+Qj2JfFXAIr2zs4U2vqP6ZrEglf3yk9yedrx24IANSH5R8H1urooaWM7zdhbCPhl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.379.1/LICENSE
```

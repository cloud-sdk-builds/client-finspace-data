...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.632.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.632.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kQ/c9u2E5PQ6QeCAzehk91QBmS8AfWCZLT5hDEN+T5bGKja9fLP3+t5UB+qS7tb1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.632.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.632.0/index.min.mjs": "sha384-kQ/c9u2E5PQ6QeCAzehk91QBmS8AfWCZLT5hDEN+T5bGKja9fLP3+t5UB+qS7tb1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.632.0/LICENSE
```

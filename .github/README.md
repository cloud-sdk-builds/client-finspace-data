...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.201.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.201.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5XYx64eXKA4j+U+SpwNG5nHolFfJfOcUM/2/NJQ6ZsyK3+wbaHMyGQCvGdCWhGld
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.201.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.201.0/index.min.mjs": "sha384-5XYx64eXKA4j+U+SpwNG5nHolFfJfOcUM/2/NJQ6ZsyK3+wbaHMyGQCvGdCWhGld"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.201.0/LICENSE
```

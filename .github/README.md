...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.1018.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1018.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yBeLWk5AanQ9H6s5TWq4GZvVBiGZK19ErN823/zDTf0uG9R9hEaF/BJcTb1v7YBM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1018.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1018.0/index.min.mjs": "sha384-yBeLWk5AanQ9H6s5TWq4GZvVBiGZK19ErN823/zDTf0uG9R9hEaF/BJcTb1v7YBM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.1018.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.975.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.975.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-H5SxqNeZ9kaNo/QlKFaIaOhd/GNI1Rv33DZ8mFVpWqFvcS1R+YrvZlduBJGf5E4R
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.975.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.975.0/index.min.mjs": "sha384-H5SxqNeZ9kaNo/QlKFaIaOhd/GNI1Rv33DZ8mFVpWqFvcS1R+YrvZlduBJGf5E4R"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.975.0/LICENSE
```

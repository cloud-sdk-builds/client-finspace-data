...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.563.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.563.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IADXKkj3EFIJCLDBEc90g1Z37yJx1EqFbTJRcCyjpglLjrMM/SpBue6ZbzwK4ptF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.563.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.563.0/index.min.mjs": "sha384-IADXKkj3EFIJCLDBEc90g1Z37yJx1EqFbTJRcCyjpglLjrMM/SpBue6ZbzwK4ptF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.563.0/LICENSE
```

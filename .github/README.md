...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.362.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.362.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/uMxHSPW0Fe1CwD5gCGfc5ONC1cHLcqYUkeV+nhOLtQmt5uKUnOxFuC6IfG6DRZv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.362.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.362.0/index.min.mjs": "sha384-/uMxHSPW0Fe1CwD5gCGfc5ONC1cHLcqYUkeV+nhOLtQmt5uKUnOxFuC6IfG6DRZv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.362.0/LICENSE
```

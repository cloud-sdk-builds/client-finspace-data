...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.131.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.131.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OWAGqWeRL/BHBJ/W9VhVbocPz3EaXNvhqMIOJuK8r2j1X5TzBPSu4U3HACsv/JlE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.131.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.131.0/index.min.mjs": "sha384-OWAGqWeRL/BHBJ/W9VhVbocPz3EaXNvhqMIOJuK8r2j1X5TzBPSu4U3HACsv/JlE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.131.0/LICENSE
```

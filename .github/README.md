...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.223.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.223.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NapDf7O5ctvRWDez6gJ86yor8wCFF2wFlU/qSd4FQUBqXDH7Hbga//jNgi/8nVzq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.223.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.223.0/index.min.mjs": "sha384-NapDf7O5ctvRWDez6gJ86yor8wCFF2wFlU/qSd4FQUBqXDH7Hbga//jNgi/8nVzq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.223.0/LICENSE
```

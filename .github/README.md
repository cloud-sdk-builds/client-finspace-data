...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.1029.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1029.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3FNzZfnpqdAE+XPCv1miz+srgY3NrKlsxKDNHtefXJqDM5m6bKcT1QYLU1qV1Ymm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1029.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1029.0/index.min.mjs": "sha384-3FNzZfnpqdAE+XPCv1miz+srgY3NrKlsxKDNHtefXJqDM5m6bKcT1QYLU1qV1Ymm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.1029.0/LICENSE
```

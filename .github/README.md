...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.300.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.300.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DzMp7UJk1ufVFaX9Fw1l4Gf1FyGQrBNKwjWqUvfIEOYCSn41t2ruoffhcz/woa4Y
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.300.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.300.0/index.min.mjs": "sha384-DzMp7UJk1ufVFaX9Fw1l4Gf1FyGQrBNKwjWqUvfIEOYCSn41t2ruoffhcz/woa4Y"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.300.0/LICENSE
```

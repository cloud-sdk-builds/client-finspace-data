...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.598.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.598.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-H8j8nm7dy4cjIwNVKeL6rF5LWOvEOh2AbTe7oubXYrc0e9MucAIuaAGHdXgW8Cil
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.598.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.598.0/index.min.mjs": "sha384-H8j8nm7dy4cjIwNVKeL6rF5LWOvEOh2AbTe7oubXYrc0e9MucAIuaAGHdXgW8Cil"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.598.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.38.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.38.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5AdmJcExzt/fHdEEMF1eZm0oISgyBL5HwqU9p1Ai3E08x3nQRYl/sK6NS/zbsqRl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.38.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.38.0/index.min.mjs": "sha384-5AdmJcExzt/fHdEEMF1eZm0oISgyBL5HwqU9p1Ai3E08x3nQRYl/sK6NS/zbsqRl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.38.0/LICENSE
```

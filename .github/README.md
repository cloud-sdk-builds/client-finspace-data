...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.726.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.726.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-S3ZddDSEmDFS7Zk/2yJ63dXfNaM9Xtgd5TYRIWIrebSup1M8508pCuI+XdDyPZBk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.726.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.726.0/index.min.mjs": "sha384-S3ZddDSEmDFS7Zk/2yJ63dXfNaM9Xtgd5TYRIWIrebSup1M8508pCuI+XdDyPZBk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.726.0/LICENSE
```

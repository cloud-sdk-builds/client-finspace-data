...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.549.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.549.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vWSV1Bo0pn0T6PmoKwx5Fyp2H34SraLvit1VCjuYdn0iSjdcEkgW5SLJ6zEz0mco
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.549.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.549.0/index.min.mjs": "sha384-vWSV1Bo0pn0T6PmoKwx5Fyp2H34SraLvit1VCjuYdn0iSjdcEkgW5SLJ6zEz0mco"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.549.0/LICENSE
```

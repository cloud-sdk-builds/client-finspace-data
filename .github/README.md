...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.282.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.282.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WfZdGfcopVMe0fC1rUe5ZMAJXLTzNWkiBaAa6/VfYO0dYZTOj9+2eVBZGfsncFKV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.282.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.282.0/index.min.mjs": "sha384-WfZdGfcopVMe0fC1rUe5ZMAJXLTzNWkiBaAa6/VfYO0dYZTOj9+2eVBZGfsncFKV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.282.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.896.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.896.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VFdcTsRPGzmGeyR9vfGe3TL+RYYdpt4wT+ZLg4BYFQBT3iAoqYf4MOSOMYb9gXQz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.896.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.896.0/index.min.mjs": "sha384-VFdcTsRPGzmGeyR9vfGe3TL+RYYdpt4wT+ZLg4BYFQBT3iAoqYf4MOSOMYb9gXQz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.896.0/LICENSE
```

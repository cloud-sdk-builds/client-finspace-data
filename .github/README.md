...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.911.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.911.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JeoQ4Brl31UR4B+Y8+YgPrQkJUxi3JFECdURaS3QvNzfNu37TaAsOUZaCCWblA6z
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.911.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.911.0/index.min.mjs": "sha384-JeoQ4Brl31UR4B+Y8+YgPrQkJUxi3JFECdURaS3QvNzfNu37TaAsOUZaCCWblA6z"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.911.0/LICENSE
```

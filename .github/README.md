...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.196.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.196.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-i6/L86Uu8wS0JGIsSNa5BGyB1xq5o1euKmt23vimSEqwvcW0w+u0eg/HOgbsHd07
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.196.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.196.0/index.min.mjs": "sha384-i6/L86Uu8wS0JGIsSNa5BGyB1xq5o1euKmt23vimSEqwvcW0w+u0eg/HOgbsHd07"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.196.0/LICENSE
```

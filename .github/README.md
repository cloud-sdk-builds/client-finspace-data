...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.554.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.554.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-T5Mj4e0A98cnxeIeb/2WPjr4D39soeEgpCgd3ZCahbVDVeNUX95+M6VNjuW6Mq+T
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.554.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.554.0/index.min.mjs": "sha384-T5Mj4e0A98cnxeIeb/2WPjr4D39soeEgpCgd3ZCahbVDVeNUX95+M6VNjuW6Mq+T"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.554.0/LICENSE
```

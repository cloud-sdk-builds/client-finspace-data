...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.105.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.105.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4VgcyuE+T9JuhpSrbXeuTgIqiOef3rFbRB2DEkieAKS59OGkBKl5oA6AVriuUr9Y
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.105.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.105.0/index.min.mjs": "sha384-4VgcyuE+T9JuhpSrbXeuTgIqiOef3rFbRB2DEkieAKS59OGkBKl5oA6AVriuUr9Y"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.105.0/LICENSE
```

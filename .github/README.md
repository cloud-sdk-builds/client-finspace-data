...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.48.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.48.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MHy3KPC4BwDrA7J5Rwh2XLs8KOjXb4/3yEEQZVNH6yc5TA+QvhvqndPEb5naJ6xw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.48.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.48.0/index.min.mjs": "sha384-MHy3KPC4BwDrA7J5Rwh2XLs8KOjXb4/3yEEQZVNH6yc5TA+QvhvqndPEb5naJ6xw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.48.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.496.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.496.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wpjWPPAJAvernCAWh19KKcm8nzIWgC2y9DeClj1gq+L+I8dB8/tdnQXxBP4QPQIV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.496.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.496.0/index.min.mjs": "sha384-wpjWPPAJAvernCAWh19KKcm8nzIWgC2y9DeClj1gq+L+I8dB8/tdnQXxBP4QPQIV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.496.0/LICENSE
```

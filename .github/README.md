...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.622.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.622.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MncSLdeYXY/XbrmqoD7Fd2WFxv/+lqJtwXCwG57Ez6JZF4z7QtPRDAN8eGuCkteX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.622.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.622.0/index.min.mjs": "sha384-MncSLdeYXY/XbrmqoD7Fd2WFxv/+lqJtwXCwG57Ez6JZF4z7QtPRDAN8eGuCkteX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.622.0/LICENSE
```

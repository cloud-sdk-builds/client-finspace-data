...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.886.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.886.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vJ94esWt7PRUZORsBUTNhtQKV0vwuPMo3lIWRdoP7+ZAFd1ogYh9LhfI2cIevvIV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.886.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.886.0/index.min.mjs": "sha384-vJ94esWt7PRUZORsBUTNhtQKV0vwuPMo3lIWRdoP7+ZAFd1ogYh9LhfI2cIevvIV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.886.0/LICENSE
```

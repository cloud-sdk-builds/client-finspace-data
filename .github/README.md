...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.629.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.629.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-egOKPRSt8psH3Sa2L1vhpbRnMZgXOgvtxyTu0JRhUdcLbc34ilI+3f23rNrqgQzs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.629.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.629.0/index.min.mjs": "sha384-egOKPRSt8psH3Sa2L1vhpbRnMZgXOgvtxyTu0JRhUdcLbc34ilI+3f23rNrqgQzs"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.629.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.1040.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1040.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4zjsdVLw/fc+3wgZcymdey5yOZkCVSj5MLK39MzKNwrx0XaZQKmzfSj04g1vi0sv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1040.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1040.0/index.min.mjs": "sha384-4zjsdVLw/fc+3wgZcymdey5yOZkCVSj5MLK39MzKNwrx0XaZQKmzfSj04g1vi0sv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.1040.0/LICENSE
```

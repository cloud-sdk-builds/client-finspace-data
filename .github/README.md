...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.298.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.298.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SUcw0dEWHfS53TsQuZsTj+zOo7KuMhdFpSb88MmnU6aHMCkEeo+5N7jbmn/R+fzE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.298.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.298.0/index.min.mjs": "sha384-SUcw0dEWHfS53TsQuZsTj+zOo7KuMhdFpSb88MmnU6aHMCkEeo+5N7jbmn/R+fzE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.298.0/LICENSE
```

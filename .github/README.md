...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.521.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.521.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wZLI2zRrX+ZH94f/PcJRly/gdjkII/Zpe3sCRyQ9gLx2gr/DOxVtqz/gqGCDGq9V
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.521.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.521.0/index.min.mjs": "sha384-wZLI2zRrX+ZH94f/PcJRly/gdjkII/Zpe3sCRyQ9gLx2gr/DOxVtqz/gqGCDGq9V"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.521.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.948.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.948.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-c35LjaawDjxhrQQq0huYH6B3U+RSluAQhRsr86tjn5JLa8eq/jnOjYP0r5+92tXL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.948.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.948.0/index.min.mjs": "sha384-c35LjaawDjxhrQQq0huYH6B3U+RSluAQhRsr86tjn5JLa8eq/jnOjYP0r5+92tXL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.948.0/LICENSE
```

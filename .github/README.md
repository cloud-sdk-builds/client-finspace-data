...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.378.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.378.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Qxg8pAq74HezEluK1sRMieX5JLUbWlSN/NHLtFE+mqs5pjoBrnJmkajFd54Su+7M
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.378.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.378.0/index.min.mjs": "sha384-Qxg8pAq74HezEluK1sRMieX5JLUbWlSN/NHLtFE+mqs5pjoBrnJmkajFd54Su+7M"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.378.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.46.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.46.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-EerLdOfM4HD7QEkfsS36UcOc0BiYQnZnfAkDS8vJ6sGbupxCXYNlPU00CN3Ch5lj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.46.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.46.0/index.min.mjs": "sha384-EerLdOfM4HD7QEkfsS36UcOc0BiYQnZnfAkDS8vJ6sGbupxCXYNlPU00CN3Ch5lj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.46.0/LICENSE
```

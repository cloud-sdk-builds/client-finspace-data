...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.264.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.264.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ivsYfoz0LZKvZzg3dN/bvVqEMI1fh9RlQr2mfBHH/9l+d6+thJKBcLNL5DrLeU00
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.264.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.264.0/index.min.mjs": "sha384-ivsYfoz0LZKvZzg3dN/bvVqEMI1fh9RlQr2mfBHH/9l+d6+thJKBcLNL5DrLeU00"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.264.0/LICENSE
```

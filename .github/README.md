...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.568.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.568.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+v2u2YrV91OQUYgXTChEqMgl21Pc9zVoSj8UUqfzg4sCH/H82rUTPk109f8FZtVA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.568.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.568.0/index.min.mjs": "sha384-+v2u2YrV91OQUYgXTChEqMgl21Pc9zVoSj8UUqfzg4sCH/H82rUTPk109f8FZtVA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.568.0/LICENSE
```

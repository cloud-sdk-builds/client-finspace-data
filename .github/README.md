...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.451.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.451.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pV6iFVy3Md9VJvD1ITgOlpZVUYfWnxxrkJVgHbdiwZ+RQV4Ga+j3CGIJNURNC0vw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.451.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.451.0/index.min.mjs": "sha384-pV6iFVy3Md9VJvD1ITgOlpZVUYfWnxxrkJVgHbdiwZ+RQV4Ga+j3CGIJNURNC0vw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.451.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.826.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.826.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ygUhJK2WumwHfgzu+aKS4+wJYbx4p95LdATPP4sBsxMdWVoG6zDKz/w2S1DlSgT+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.826.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.826.0/index.min.mjs": "sha384-ygUhJK2WumwHfgzu+aKS4+wJYbx4p95LdATPP4sBsxMdWVoG6zDKz/w2S1DlSgT+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.826.0/LICENSE
```

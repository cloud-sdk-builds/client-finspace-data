...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.812.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.812.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-t7Zl9RQUbRLPSVf/qfTmpXHS6JasW2re5z1eJYAuBe9DKNv5dmW8VJToS9Gfgoyr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.812.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.812.0/index.min.mjs": "sha384-t7Zl9RQUbRLPSVf/qfTmpXHS6JasW2re5z1eJYAuBe9DKNv5dmW8VJToS9Gfgoyr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.812.0/LICENSE
```

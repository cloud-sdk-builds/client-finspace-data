...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.970.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.970.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-TzdzNv2EjvWUbwxaFiw942+zdGDQrwCTKHLgZC2h/RZXfIJmc/vc8jATpM5YK1e9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.970.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.970.0/index.min.mjs": "sha384-TzdzNv2EjvWUbwxaFiw942+zdGDQrwCTKHLgZC2h/RZXfIJmc/vc8jATpM5YK1e9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.970.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.85.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.85.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/FO5+EJGvAfIDZ/e7b7LFyObz52Dht1PV6BCIFqqoIcAc5I5chJheZfeP8SamvUF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.85.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.85.0/index.min.mjs": "sha384-/FO5+EJGvAfIDZ/e7b7LFyObz52Dht1PV6BCIFqqoIcAc5I5chJheZfeP8SamvUF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.85.0/LICENSE
```

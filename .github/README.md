...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.984.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.984.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AY/o9lOsD/wcqjokvzU/fsWaBRMvT/8d8kDwJnz5EC95gCmpRLox7U/yxSC6J4Pq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.984.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.984.0/index.min.mjs": "sha384-AY/o9lOsD/wcqjokvzU/fsWaBRMvT/8d8kDwJnz5EC95gCmpRLox7U/yxSC6J4Pq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.984.0/LICENSE
```

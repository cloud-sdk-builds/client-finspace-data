...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.921.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.921.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-l4Z/SrRFzjYMYpsljTtMMNb49fhmrF1UKfywd7rht3AlPjZg8Yu4/3UWs/hWxpqA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.921.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.921.0/index.min.mjs": "sha384-l4Z/SrRFzjYMYpsljTtMMNb49fhmrF1UKfywd7rht3AlPjZg8Yu4/3UWs/hWxpqA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.921.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.1090.0).
...
- @aws-sdk/client-finspace-data v3.1090.0 - [https://cloud-sdk-builds.github.io/?sdk=client-finspace-data&version=3.1090.0](https://cloud-sdk-builds.github.io/?sdk=client-finspace-data&version=3.1090.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1090.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6UUFKKEslwRoapw6DBI0cW2y0mmwiwR1UkHrok1f1hnot5r5tFw4aeyWXWDQ23u4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1090.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1090.0/index.min.mjs": "sha384-6UUFKKEslwRoapw6DBI0cW2y0mmwiwR1UkHrok1f1hnot5r5tFw4aeyWXWDQ23u4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.1090.0/LICENSE
```

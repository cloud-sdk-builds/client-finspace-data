...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.635.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.635.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-iyqRu7HmsZfcHVoBysqm9PPvtKOng8maYM54H6d09DcqEp5igaHdHOAcYJiBIh9b
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.635.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.635.0/index.min.mjs": "sha384-iyqRu7HmsZfcHVoBysqm9PPvtKOng8maYM54H6d09DcqEp5igaHdHOAcYJiBIh9b"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.635.0/LICENSE
```

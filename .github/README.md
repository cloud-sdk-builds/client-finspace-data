...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.435.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.435.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-w56ovm3NxSuz06IrdQresp1ZOro4oGKK5HCMJrWcWfXfMkJ2mbyq6MtJJpTEeAR1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.435.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.435.0/index.min.mjs": "sha384-w56ovm3NxSuz06IrdQresp1ZOro4oGKK5HCMJrWcWfXfMkJ2mbyq6MtJJpTEeAR1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.435.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.452.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.452.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MOevIgawReMYzW6MOv49AMjUUFKhbBcf81aNbN3wqsdKLxEJ0/Ob9gV25XN7mUiW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.452.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.452.0/index.min.mjs": "sha384-MOevIgawReMYzW6MOv49AMjUUFKhbBcf81aNbN3wqsdKLxEJ0/Ob9gV25XN7mUiW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.452.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.170.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.170.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-clJEjXQ3/srN4RgvkkKzj/fzu2dpm2JRyfh0bzsUOc0TnEuEo2isIqVu5UX2dSHf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.170.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.170.0/index.min.mjs": "sha384-clJEjXQ3/srN4RgvkkKzj/fzu2dpm2JRyfh0bzsUOc0TnEuEo2isIqVu5UX2dSHf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.170.0/LICENSE
```

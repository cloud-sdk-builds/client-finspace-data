...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.261.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.261.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-eAB7a55IMiFBZqJY33T6XWIZDpenpFafGLjmaIJFPj2c6TJTgmg9DXde5q4AivO/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.261.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.261.0/index.min.mjs": "sha384-eAB7a55IMiFBZqJY33T6XWIZDpenpFafGLjmaIJFPj2c6TJTgmg9DXde5q4AivO/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.261.0/LICENSE
```

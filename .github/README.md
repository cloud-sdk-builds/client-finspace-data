...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.413.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.413.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Y/9Kzoai7pLUxbN+yX3xrZ9nFpiAgKeOg4SzusM7EIU9iak8lKdWSBA+roiK3fMI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.413.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.413.0/index.min.mjs": "sha384-Y/9Kzoai7pLUxbN+yX3xrZ9nFpiAgKeOg4SzusM7EIU9iak8lKdWSBA+roiK3fMI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.413.0/LICENSE
```

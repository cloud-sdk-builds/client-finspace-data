...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.337.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.337.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4m9wkgBijw9ohHqtIYf3ow+jZI7+FbXWt3KVi96he1dh0cUP8clhS5kCOYr6F8lk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.337.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.337.0/index.min.mjs": "sha384-4m9wkgBijw9ohHqtIYf3ow+jZI7+FbXWt3KVi96he1dh0cUP8clhS5kCOYr6F8lk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.337.0/LICENSE
```

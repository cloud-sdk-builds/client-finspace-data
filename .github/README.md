...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.535.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.535.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-j/mwTrnn/gHgy/LilGL1UX9PTcccwJhd+YLRobpemPdI0EIDrIOSpR4G25fx3CKb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.535.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.535.0/index.min.mjs": "sha384-j/mwTrnn/gHgy/LilGL1UX9PTcccwJhd+YLRobpemPdI0EIDrIOSpR4G25fx3CKb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.535.0/LICENSE
```

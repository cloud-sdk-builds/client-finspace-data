...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.934.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.934.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5sRd1G8Nyfdf3E56gKUeyKE0t7S0SNQ7DohHba+ks0g4hFiMdT+XpodHwIKDbpLR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.934.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.934.0/index.min.mjs": "sha384-5sRd1G8Nyfdf3E56gKUeyKE0t7S0SNQ7DohHba+ks0g4hFiMdT+XpodHwIKDbpLR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.934.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.423.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.423.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0PJjf0NfRl4AzCCWYyToOCKleXRT3jQe9UKDZVPDJeAHUkqi8e26rn6zS2LidFf5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.423.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.423.0/index.min.mjs": "sha384-0PJjf0NfRl4AzCCWYyToOCKleXRT3jQe9UKDZVPDJeAHUkqi8e26rn6zS2LidFf5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.423.0/LICENSE
```

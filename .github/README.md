...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.679.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.679.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cGYAr2+vTMtbxSfZ2kLnCGesZObKmsI7vYoDC+ROvOGYzv0FtT6twN0Do++C60iV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.679.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.679.0/index.min.mjs": "sha384-cGYAr2+vTMtbxSfZ2kLnCGesZObKmsI7vYoDC+ROvOGYzv0FtT6twN0Do++C60iV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.679.0/LICENSE
```

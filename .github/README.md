...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.919.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.919.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9XLDg4QeYik3ruFjNKrGeAVWo5qbetRuGv2lSsMVAFJVR/mk3KMq+KU2yFwpAsL2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.919.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.919.0/index.min.mjs": "sha384-9XLDg4QeYik3ruFjNKrGeAVWo5qbetRuGv2lSsMVAFJVR/mk3KMq+KU2yFwpAsL2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.919.0/LICENSE
```

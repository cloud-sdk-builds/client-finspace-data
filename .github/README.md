...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.592.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.592.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RyEDsw2OQcSEJqbnvczdKxXckhRSBeQlFS4BoD0alBS75spgx6J2GWUJGrSHN4Z9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.592.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.592.0/index.min.mjs": "sha384-RyEDsw2OQcSEJqbnvczdKxXckhRSBeQlFS4BoD0alBS75spgx6J2GWUJGrSHN4Z9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.592.0/LICENSE
```

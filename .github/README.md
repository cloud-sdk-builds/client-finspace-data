...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.806.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.806.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IGiP76DsYRH9uXdzUapI+kUwc+AvTzWB2bQcaTaUPwEilEvfNXlX9N1Hr0SoS2IV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.806.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.806.0/index.min.mjs": "sha384-IGiP76DsYRH9uXdzUapI+kUwc+AvTzWB2bQcaTaUPwEilEvfNXlX9N1Hr0SoS2IV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.806.0/LICENSE
```

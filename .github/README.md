...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.1027.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1027.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5ZNJ3NefT614TM5KoB1oo8545LXXNn9QPnObjnf/EijdCa5d8whqv5+uMzBTDlXR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1027.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1027.0/index.min.mjs": "sha384-5ZNJ3NefT614TM5KoB1oo8545LXXNn9QPnObjnf/EijdCa5d8whqv5+uMzBTDlXR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.1027.0/LICENSE
```

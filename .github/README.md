...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.971.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.971.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VXB7wy6EO/KVGyuISP1Q0GTbxwrJ4HOqMb5nWP/MKNMPI7A7YX3qrqIPi9zWlZuZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.971.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.971.0/index.min.mjs": "sha384-VXB7wy6EO/KVGyuISP1Q0GTbxwrJ4HOqMb5nWP/MKNMPI7A7YX3qrqIPi9zWlZuZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.971.0/LICENSE
```

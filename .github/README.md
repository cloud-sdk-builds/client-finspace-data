...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.29.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.29.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-TIZzYNoPZj4N5nS7nAzdv5Vz1dLPVa42VEbkD1cmcB7L96pma1CLlY6E9pgXskJR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.29.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.29.0/index.min.mjs": "sha384-TIZzYNoPZj4N5nS7nAzdv5Vz1dLPVa42VEbkD1cmcB7L96pma1CLlY6E9pgXskJR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.29.0/LICENSE
```

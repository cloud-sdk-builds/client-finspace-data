...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.511.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.511.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nEmoBEwe71p6CNrwOJ0wYOCErlaZpebPkp3X7SBSQNVJJ86U8A8NpBYjZrdaiqEA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.511.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.511.0/index.min.mjs": "sha384-nEmoBEwe71p6CNrwOJ0wYOCErlaZpebPkp3X7SBSQNVJJ86U8A8NpBYjZrdaiqEA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.511.0/LICENSE
```

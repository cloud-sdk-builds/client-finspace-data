...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.956.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.956.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-snjtUB9h+b+EhQ4WgQF8HCSKndiF4s9nx0m3BglvFFTsdIkU1ELM4O9VhusJUqu5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.956.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.956.0/index.min.mjs": "sha384-snjtUB9h+b+EhQ4WgQF8HCSKndiF4s9nx0m3BglvFFTsdIkU1ELM4O9VhusJUqu5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.956.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.499.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.499.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2N487u3Skn4HUYdOeKPp1jBujoM0yhw5PkT/coBtWW0LgW2KkbHXM10EPx7gCFtL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.499.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.499.0/index.min.mjs": "sha384-2N487u3Skn4HUYdOeKPp1jBujoM0yhw5PkT/coBtWW0LgW2KkbHXM10EPx7gCFtL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.499.0/LICENSE
```

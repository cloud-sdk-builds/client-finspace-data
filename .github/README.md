...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.19.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.19.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DFnQVoP1zumzm2AQqO3L/Bik9im2X4bkOmVQTA06llIQZlQ8I0D+oFGaCV+hRbc2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.19.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.19.0/index.min.mjs": "sha384-DFnQVoP1zumzm2AQqO3L/Bik9im2X4bkOmVQTA06llIQZlQ8I0D+oFGaCV+hRbc2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.19.0/LICENSE
```

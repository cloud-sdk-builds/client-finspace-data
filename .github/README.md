...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.645.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.645.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2hJyjGXEkjefQzlbjZfihuS8SkmVcPRUr6Xfo5NArAO3u5g+kPt7UNCtzYxk1jRJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.645.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.645.0/index.min.mjs": "sha384-2hJyjGXEkjefQzlbjZfihuS8SkmVcPRUr6Xfo5NArAO3u5g+kPt7UNCtzYxk1jRJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.645.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.81.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.81.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vnpDAG1dBenlE72YvQiQj81g0VxzkeBDR6p9L7vp3U867aKHIOfO8vh62RPvBIKu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.81.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.81.0/index.min.mjs": "sha384-vnpDAG1dBenlE72YvQiQj81g0VxzkeBDR6p9L7vp3U867aKHIOfO8vh62RPvBIKu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.81.0/LICENSE
```

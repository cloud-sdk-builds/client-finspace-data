...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.338.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.338.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xnsBIJ5s/sX05kL1+Ry+8TbeRF1abtJ99m3+dP6FUFeJxh/IWcz8xUcT35FHWv38
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.338.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.338.0/index.min.mjs": "sha384-xnsBIJ5s/sX05kL1+Ry+8TbeRF1abtJ99m3+dP6FUFeJxh/IWcz8xUcT35FHWv38"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.338.0/LICENSE
```

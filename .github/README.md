...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.449.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.449.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IVkpjR2rmWCMgplabuShgxk5VUdPHwN1DEsSV5X1qrw/bP2AsmqrBRFD3oOzu2Gp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.449.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.449.0/index.min.mjs": "sha384-IVkpjR2rmWCMgplabuShgxk5VUdPHwN1DEsSV5X1qrw/bP2AsmqrBRFD3oOzu2Gp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.449.0/LICENSE
```

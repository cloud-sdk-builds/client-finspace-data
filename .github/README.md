...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.80.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.80.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qd0Iv61HsTUcXhNOIT8eBSz+2z7MzoF7qK4lk5n/yZDzqeoSHTxcQG4qXVG9yMxR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.80.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.80.0/index.min.mjs": "sha384-qd0Iv61HsTUcXhNOIT8eBSz+2z7MzoF7qK4lk5n/yZDzqeoSHTxcQG4qXVG9yMxR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.80.0/LICENSE
```

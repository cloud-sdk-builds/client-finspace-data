...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.40.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.40.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aSoHowi6CEdxh6az2A9ZF611ClL2pnUAdF6X7gpgbBZxdlwofukMQes+it6wBt49
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.40.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.40.0/index.min.mjs": "sha384-aSoHowi6CEdxh6az2A9ZF611ClL2pnUAdF6X7gpgbBZxdlwofukMQes+it6wBt49"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.40.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.128.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.128.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-c5V2yt+oADsKKROa6i34KvalBwzA9PEHsSoLf2Gx91hLQgABRQ+hS6N3Qeudkr8w
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.128.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.128.0/index.min.mjs": "sha384-c5V2yt+oADsKKROa6i34KvalBwzA9PEHsSoLf2Gx91hLQgABRQ+hS6N3Qeudkr8w"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.128.0/LICENSE
```

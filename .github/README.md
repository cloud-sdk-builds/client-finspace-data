...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.514.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.514.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2cowqCfARH2dJv2hk5v2C9n6XYm45/e2wVxzSVR0uoRrqSutSXgD42mSjcNkvq0d
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.514.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.514.0/index.min.mjs": "sha384-2cowqCfARH2dJv2hk5v2C9n6XYm45/e2wVxzSVR0uoRrqSutSXgD42mSjcNkvq0d"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.514.0/LICENSE
```

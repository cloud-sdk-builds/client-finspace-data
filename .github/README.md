...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.421.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.421.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9HaA3oyAwXaE87R89iUDq5fXJoKFGb2EUi/5LWSVoXOgW+D1csGlMsq59H0O96Es
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.421.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.421.0/index.min.mjs": "sha384-9HaA3oyAwXaE87R89iUDq5fXJoKFGb2EUi/5LWSVoXOgW+D1csGlMsq59H0O96Es"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.421.0/LICENSE
```

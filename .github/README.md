...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.332.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.332.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WawkhR8ficrnwqqCidZcGpHH7dGFja76OtEtp3GtDQX3StgO0d6bPJ05ciTu3Lc/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.332.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.332.0/index.min.mjs": "sha384-WawkhR8ficrnwqqCidZcGpHH7dGFja76OtEtp3GtDQX3StgO0d6bPJ05ciTu3Lc/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.332.0/LICENSE
```

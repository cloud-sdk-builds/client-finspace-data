...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.994.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.994.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bNXdwFaPnM+UlRf81j8D8v6J+29Hw8ED7H+R0LK41yFQvOTaPosCPF84DLM+huA3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.994.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.994.0/index.min.mjs": "sha384-bNXdwFaPnM+UlRf81j8D8v6J+29Hw8ED7H+R0LK41yFQvOTaPosCPF84DLM+huA3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.994.0/LICENSE
```

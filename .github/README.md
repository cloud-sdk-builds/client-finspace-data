...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.90.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.90.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Ghx4WpHvVlJ57zKTiCfHpXJ7Nc7JqQ4CDRJjg8H5zZP0QzR7dNLMyGyFqorv5NIu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.90.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.90.0/index.min.mjs": "sha384-Ghx4WpHvVlJ57zKTiCfHpXJ7Nc7JqQ4CDRJjg8H5zZP0QzR7dNLMyGyFqorv5NIu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.90.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.1099.0).
...
- @aws-sdk/client-finspace-data v3.1099.0 - [https://cloud-sdk-builds.github.io/?sdk=client-finspace-data&version=3.1099.0](https://cloud-sdk-builds.github.io/?sdk=client-finspace-data&version=3.1099.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1099.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FmO2OhHXb1nJWH1uPBdOlyAx5iROY3C5XWJrlL0qGR1zh2kG84FtZQ7d2ExUg36T
```
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1099.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1099.0/index.min.mjs": "sha384-FmO2OhHXb1nJWH1uPBdOlyAx5iROY3C5XWJrlL0qGR1zh2kG84FtZQ7d2ExUg36T"
        }
      }
</script>
```
...
<html lang="en">
      ...
      <body>
            <h1>Hello World!</h1>
            <script type="module">
                  import {  } from "@aws-sdk/client-finspace-data";
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.1099.0/LICENSE
```

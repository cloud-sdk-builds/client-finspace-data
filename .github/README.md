...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.231.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.231.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lqIWX/VyLD+CJrCfb2/8JnyvGdZemcveZAcUxeJIeL9ZwnvWbiCsaSQf95Q1pDVs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.231.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.231.0/index.min.mjs": "sha384-lqIWX/VyLD+CJrCfb2/8JnyvGdZemcveZAcUxeJIeL9ZwnvWbiCsaSQf95Q1pDVs"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.231.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.316.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.316.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-614lVF5ogk3aATbUDijz01KRPGfw1rKOb2c09EB0p7qbDwftUThpc9FpR5cnMqva
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.316.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.316.0/index.min.mjs": "sha384-614lVF5ogk3aATbUDijz01KRPGfw1rKOb2c09EB0p7qbDwftUThpc9FpR5cnMqva"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.316.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.998.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.998.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pNiHgbWB38T2K03hkBG98mFEpxsNLUg0p+53lDOZh+yaLZL5SpUBVGUnhnEuuIis
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.998.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.998.0/index.min.mjs": "sha384-pNiHgbWB38T2K03hkBG98mFEpxsNLUg0p+53lDOZh+yaLZL5SpUBVGUnhnEuuIis"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.998.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.58.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.58.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mmR1cy6wEjajL5j4JHcZvkFIHukypUAfjFK5ZYC+Hhvl9USGzoH5gAisXYU6mdbF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.58.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.58.0/index.min.mjs": "sha384-mmR1cy6wEjajL5j4JHcZvkFIHukypUAfjFK5ZYC+Hhvl9USGzoH5gAisXYU6mdbF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.58.0/LICENSE
```

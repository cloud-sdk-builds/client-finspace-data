...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.186.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.186.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rb+lFAfEtwiYmT/ZxNYaberq9CDp2pzkvK/9359PIGE5GSg0xU06zcIQOD6DzGk8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.186.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.186.0/index.min.mjs": "sha384-rb+lFAfEtwiYmT/ZxNYaberq9CDp2pzkvK/9359PIGE5GSg0xU06zcIQOD6DzGk8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.186.0/LICENSE
```

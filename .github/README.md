...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.288.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.288.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oVpSHSw+5i/S09GKSfPSVH9d/3KS23n1QxZG1LAqguOCWVKLph0JZqYXWGLbLRNK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.288.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.288.0/index.min.mjs": "sha384-oVpSHSw+5i/S09GKSfPSVH9d/3KS23n1QxZG1LAqguOCWVKLph0JZqYXWGLbLRNK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.288.0/LICENSE
```

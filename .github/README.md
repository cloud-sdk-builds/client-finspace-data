...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.1015.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1015.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-P7dMPJ2OAcGBiXs8k1wxVq33I1O4pqDqwl/fEdxtqr1peS1t2hunCSNB0uZH0KGX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1015.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1015.0/index.min.mjs": "sha384-P7dMPJ2OAcGBiXs8k1wxVq33I1O4pqDqwl/fEdxtqr1peS1t2hunCSNB0uZH0KGX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.1015.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.229.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.229.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-e7zBTVer7IwKsJH+aeSam/QH8Svzj29aFP4bfxTaFDFU/JjbBPov3tJENLN5hjjC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.229.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.229.0/index.min.mjs": "sha384-e7zBTVer7IwKsJH+aeSam/QH8Svzj29aFP4bfxTaFDFU/JjbBPov3tJENLN5hjjC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.229.0/LICENSE
```

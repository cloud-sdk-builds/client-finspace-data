...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.533.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.533.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ox8WOj13FxOgzhziCGwJZj87/lCrXXxuOtVRjDLQTA8lm7sbEo64HEwPR7nJalyj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.533.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.533.0/index.min.mjs": "sha384-ox8WOj13FxOgzhziCGwJZj87/lCrXXxuOtVRjDLQTA8lm7sbEo64HEwPR7nJalyj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.533.0/LICENSE
```

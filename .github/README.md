...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.385.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.385.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zrl1XzdizhQ3mmSDckkXN97/2HE3LJon8q5lSsnqTSZPowb73vzGDrAIpyykbsGw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.385.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.385.0/index.min.mjs": "sha384-zrl1XzdizhQ3mmSDckkXN97/2HE3LJon8q5lSsnqTSZPowb73vzGDrAIpyykbsGw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.385.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.369.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.369.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-stNgUwheUjm/Kz01S/LBad0n5Z/kxgd8VNmfybaSQtw5e+s6sGaqb5NejDcro8v5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.369.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.369.0/index.min.mjs": "sha384-stNgUwheUjm/Kz01S/LBad0n5Z/kxgd8VNmfybaSQtw5e+s6sGaqb5NejDcro8v5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.369.0/LICENSE
```

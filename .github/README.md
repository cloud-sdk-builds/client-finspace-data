...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.42.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.42.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zlB968fY4rGVaOG3y/lO4q7T0hZjWkdxgWRD7qhadsqvEInAPb2QssfemfdL+eb1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.42.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.42.0/index.min.mjs": "sha384-zlB968fY4rGVaOG3y/lO4q7T0hZjWkdxgWRD7qhadsqvEInAPb2QssfemfdL+eb1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.42.0/LICENSE
```

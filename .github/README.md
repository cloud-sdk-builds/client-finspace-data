...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.235.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.235.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PsUkK/hxt6cgukf1ArewbBayKTK6w0AI4DBeUFrympnKkjBX10K3oyemvWFDa7ZZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.235.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.235.0/index.min.mjs": "sha384-PsUkK/hxt6cgukf1ArewbBayKTK6w0AI4DBeUFrympnKkjBX10K3oyemvWFDa7ZZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.235.0/LICENSE
```

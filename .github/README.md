...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.901.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.901.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-beBgq8UrELRCAYZgkflN5E7oJqLBJvCFykzZMHRKhUSlbWp6eYK8ngOV4vwIzdAG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.901.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.901.0/index.min.mjs": "sha384-beBgq8UrELRCAYZgkflN5E7oJqLBJvCFykzZMHRKhUSlbWp6eYK8ngOV4vwIzdAG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.901.0/LICENSE
```

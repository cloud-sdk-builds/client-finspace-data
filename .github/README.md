...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.32.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.32.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ND0AdATmdLR9oM2jU2tjNVpNyxFiLrmALfaBjJLc23Hla2aURykOSR3CFfpnax8s
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.32.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.32.0/index.min.mjs": "sha384-ND0AdATmdLR9oM2jU2tjNVpNyxFiLrmALfaBjJLc23Hla2aURykOSR3CFfpnax8s"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.32.0/LICENSE
```

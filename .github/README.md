...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.821.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.821.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ISK6rrHhCxAeSPCOHaz+O7CTKFpbSgHuJyaYileQbsXn4Kklh7364x3F6lbW85L1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.821.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.821.0/index.min.mjs": "sha384-ISK6rrHhCxAeSPCOHaz+O7CTKFpbSgHuJyaYileQbsXn4Kklh7364x3F6lbW85L1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.821.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.658.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.658.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LePifX2v3dK5JX7M+YB3S2WXkEt+c/hzfwdOYc4H0XvWXFe99+K0HtTns0kN6Hfh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.658.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.658.0/index.min.mjs": "sha384-LePifX2v3dK5JX7M+YB3S2WXkEt+c/hzfwdOYc4H0XvWXFe99+K0HtTns0kN6Hfh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.658.0/LICENSE
```

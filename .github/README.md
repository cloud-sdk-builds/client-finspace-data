...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.294.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.294.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vgOAu63IRdEsU18438cqQc8FFRFDKXRuN+PqjWS3fgOXf3g6u/za7i/v4azQhlaX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.294.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.294.0/index.min.mjs": "sha384-vgOAu63IRdEsU18438cqQc8FFRFDKXRuN+PqjWS3fgOXf3g6u/za7i/v4azQhlaX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.294.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.565.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.565.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-X5YPDvpdTfjmCO4nxqwoG4Hyn9L8O7ISK2YPaKiayhZjytsr2VOHXGhIp+xRd0Mt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.565.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.565.0/index.min.mjs": "sha384-X5YPDvpdTfjmCO4nxqwoG4Hyn9L8O7ISK2YPaKiayhZjytsr2VOHXGhIp+xRd0Mt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.565.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.22.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.22.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CzkXKEq27i/xDzGlKUKFJnTQyHxtoQDsH9oC+xWqNAe36a7TmWrIEsoBeFQkQS6H
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.22.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.22.0/index.min.mjs": "sha384-CzkXKEq27i/xDzGlKUKFJnTQyHxtoQDsH9oC+xWqNAe36a7TmWrIEsoBeFQkQS6H"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.22.0/LICENSE
```

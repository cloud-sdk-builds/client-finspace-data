...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.693.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.693.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Fxd/Fdb7uyZ8jUwjMBwlUzP+sgKkoTvXn3mh0021X25uMWl3qUt+P0ApQubHXlAj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.693.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.693.0/index.min.mjs": "sha384-Fxd/Fdb7uyZ8jUwjMBwlUzP+sgKkoTvXn3mh0021X25uMWl3qUt+P0ApQubHXlAj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.693.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.208.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.208.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-waL7rEaNXn5Rz6IdWMfs2pjkkKafKoZH56NYoyCuBydZYfUpWSnMx6teaJuKDA/9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.208.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.208.0/index.min.mjs": "sha384-waL7rEaNXn5Rz6IdWMfs2pjkkKafKoZH56NYoyCuBydZYfUpWSnMx6teaJuKDA/9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.208.0/LICENSE
```

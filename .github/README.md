...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.118.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.118.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-sZ4NHUhnFG1pEnXCunhIbVGNc4U4GVtRE6egPjhuC/jqqjAIHvI2vZtAdx+Z8CoV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.118.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.118.1/index.min.mjs": "sha384-sZ4NHUhnFG1pEnXCunhIbVGNc4U4GVtRE6egPjhuC/jqqjAIHvI2vZtAdx+Z8CoV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.118.1/LICENSE
```

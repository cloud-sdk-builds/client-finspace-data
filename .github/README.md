...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.395.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.395.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-q3nvS7jbuVZjGdcBO+cvQx291I6BBZAZA/jcbYqKYchwoEYo08IUT30c28HMNiSf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.395.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.395.0/index.min.mjs": "sha384-q3nvS7jbuVZjGdcBO+cvQx291I6BBZAZA/jcbYqKYchwoEYo08IUT30c28HMNiSf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.395.0/LICENSE
```

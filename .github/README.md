...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.932.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.932.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IoT7xvdwtoyp0y3AhsImXqF0iN1YM/bpOy4lkHV7X6Yhb1zfh0ElK+KcGs6O1PqR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.932.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.932.0/index.min.mjs": "sha384-IoT7xvdwtoyp0y3AhsImXqF0iN1YM/bpOy4lkHV7X6Yhb1zfh0ElK+KcGs6O1PqR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.932.0/LICENSE
```

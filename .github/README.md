...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.891.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.891.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5nf/smS3fsfPvH/c2JXVLeSmjNyCplhRGpOjca58LpvZJEubXueEPfIwv1Z5xhNC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.891.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.891.0/index.min.mjs": "sha384-5nf/smS3fsfPvH/c2JXVLeSmjNyCplhRGpOjca58LpvZJEubXueEPfIwv1Z5xhNC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.891.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.513.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.513.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8be00Frf51EmoUxnyTvRHEd6eDaLCBRJxOTrwGvQX3G/Sk8G0Fw88+5+fQxtkBd+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.513.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.513.0/index.min.mjs": "sha384-8be00Frf51EmoUxnyTvRHEd6eDaLCBRJxOTrwGvQX3G/Sk8G0Fw88+5+fQxtkBd+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.513.0/LICENSE
```

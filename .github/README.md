...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.354.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.354.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DYYffcQxg25GxP1W4rsMl7oiCz/Bln63VE09SS9c8Qa0e4FjdCl/FvdO7mkEuG8k
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.354.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.354.0/index.min.mjs": "sha384-DYYffcQxg25GxP1W4rsMl7oiCz/Bln63VE09SS9c8Qa0e4FjdCl/FvdO7mkEuG8k"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.354.0/LICENSE
```

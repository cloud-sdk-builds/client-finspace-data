...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.50.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.50.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tH1tghC+aay0UmUX+cqJk/tgAnkaqf2bWyXSaLgUUuJmfVa3nzg7E8uTNJwAJ8BS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.50.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.50.0/index.min.mjs": "sha384-tH1tghC+aay0UmUX+cqJk/tgAnkaqf2bWyXSaLgUUuJmfVa3nzg7E8uTNJwAJ8BS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.50.0/LICENSE
```

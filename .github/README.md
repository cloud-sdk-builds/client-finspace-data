...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.515.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.515.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WQr3pqXYrU+ymuwW8qsQnoh8dx3a1pe5qpAHCItvT8Q8LbAJi6UGAxJhOQ2bT2Fj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.515.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.515.0/index.min.mjs": "sha384-WQr3pqXYrU+ymuwW8qsQnoh8dx3a1pe5qpAHCItvT8Q8LbAJi6UGAxJhOQ2bT2Fj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.515.0/LICENSE
```

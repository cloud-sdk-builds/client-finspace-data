...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.161.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.161.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KgYX3rNQRBw32SnBJL8As1hYNGFlhRwYoMc8TyfeH8+qXxoW5e1VP8QXb2x2d33N
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.161.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.161.0/index.min.mjs": "sha384-KgYX3rNQRBw32SnBJL8As1hYNGFlhRwYoMc8TyfeH8+qXxoW5e1VP8QXb2x2d33N"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.161.0/LICENSE
```

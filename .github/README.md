...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.723.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.723.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mINOZQ3UTm7wgWY1/emp8rLzHyG2biNWx5tTuO4y3OfdGfqrPtfinaHgEw/TY85t
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.723.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.723.0/index.min.mjs": "sha384-mINOZQ3UTm7wgWY1/emp8rLzHyG2biNWx5tTuO4y3OfdGfqrPtfinaHgEw/TY85t"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.723.0/LICENSE
```

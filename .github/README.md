...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.236.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.236.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-EGYOudEnBVZkK9D0n3V+01rgfjld/gjGGHDTgQNKqd8atNCmf6f9cxPKf13KNoeO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.236.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.236.0/index.min.mjs": "sha384-EGYOudEnBVZkK9D0n3V+01rgfjld/gjGGHDTgQNKqd8atNCmf6f9cxPKf13KNoeO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.236.0/LICENSE
```

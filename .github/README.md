...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.943.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.943.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ITz6aD1ys4kfjWa28oMLDwhi0qMKwbExf3g1RcdDELAcVdYDgWJ+uyvk2CFovP8m
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.943.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.943.0/index.min.mjs": "sha384-ITz6aD1ys4kfjWa28oMLDwhi0qMKwbExf3g1RcdDELAcVdYDgWJ+uyvk2CFovP8m"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.943.0/LICENSE
```

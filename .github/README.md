...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.350.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.350.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7AqKgoDB+VIf2ITNi5OVOo3Ffkpkqtt68IlT9syQfc9RIS6fSAdziHuSdHKKwn4m
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.350.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.350.0/index.min.mjs": "sha384-7AqKgoDB+VIf2ITNi5OVOo3Ffkpkqtt68IlT9syQfc9RIS6fSAdziHuSdHKKwn4m"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.350.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.39.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.39.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rQcTIJZP+w3X8qWreOJhqe/2zcXaYCNYsOQ1bJduZgs9es6B16gbV2JbT7muzaH4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.39.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.39.0/index.min.mjs": "sha384-rQcTIJZP+w3X8qWreOJhqe/2zcXaYCNYsOQ1bJduZgs9es6B16gbV2JbT7muzaH4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.39.0/LICENSE
```

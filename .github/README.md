...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.476.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.476.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mYKzPV02h83zWMYaO1zqlEe4/IjBu4ZIw5u0Dn8bfYmnMLLrKSt/hfK1lG03uR4c
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.476.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.476.0/index.min.mjs": "sha384-mYKzPV02h83zWMYaO1zqlEe4/IjBu4ZIw5u0Dn8bfYmnMLLrKSt/hfK1lG03uR4c"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.476.0/LICENSE
```

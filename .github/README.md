...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.145.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.145.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+k01iwE9DakOmkVVFe3soy35BrBQSzTE4h7vAfe3oIbueDz7R7/iOcIdq3eeKd9/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.145.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.145.0/index.min.mjs": "sha384-+k01iwE9DakOmkVVFe3soy35BrBQSzTE4h7vAfe3oIbueDz7R7/iOcIdq3eeKd9/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.145.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.141.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.141.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xBmY/Avr5nDx2Kx/WM2Cw0t9Aa5CEElq2CHt5YNK0AzRL78u296z6V/0pJ9MaqRv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.141.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.141.0/index.min.mjs": "sha384-xBmY/Avr5nDx2Kx/WM2Cw0t9Aa5CEElq2CHt5YNK0AzRL78u296z6V/0pJ9MaqRv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.141.0/LICENSE
```

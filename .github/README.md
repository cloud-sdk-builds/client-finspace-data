...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.734.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.734.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+8uHijxvsbd3vNZACw9kcGZuAD4Z/z8x0hREFL4qrSQbAA09etWeP0pU2nsivGX5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.734.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.734.0/index.min.mjs": "sha384-+8uHijxvsbd3vNZACw9kcGZuAD4Z/z8x0hREFL4qrSQbAA09etWeP0pU2nsivGX5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.734.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.489.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.489.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wnU1qjgFhqYFISPSFnTglRiKqsI10+3vJKIE2E3409eJfpFcm5xu/3DKoBo4BJpL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.489.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.489.0/index.min.mjs": "sha384-wnU1qjgFhqYFISPSFnTglRiKqsI10+3vJKIE2E3409eJfpFcm5xu/3DKoBo4BJpL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.489.0/LICENSE
```

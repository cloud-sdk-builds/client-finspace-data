...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.142.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.142.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PRG3fKe2bWaVNe1jZ1DYBQK607rCN0eylDcCN5e3MVGPvd+39Y00s2OUjLr14IN1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.142.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.142.0/index.min.mjs": "sha384-PRG3fKe2bWaVNe1jZ1DYBQK607rCN0eylDcCN5e3MVGPvd+39Y00s2OUjLr14IN1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.142.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.1019.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1019.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-25rpUriupODuhGd4t4t8eX2jU/rBpXALe8Q6n4SdrHmYfK0vJcExl/eaeAdoAZ2v
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1019.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1019.0/index.min.mjs": "sha384-25rpUriupODuhGd4t4t8eX2jU/rBpXALe8Q6n4SdrHmYfK0vJcExl/eaeAdoAZ2v"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.1019.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.1032.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1032.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-r/IxaE9hMxINkhJ5aDB0L5Pp+jf0qPA6hhMaQRsmaag/6P/FTuRUArOVNG0spfic
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1032.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1032.0/index.min.mjs": "sha384-r/IxaE9hMxINkhJ5aDB0L5Pp+jf0qPA6hhMaQRsmaag/6P/FTuRUArOVNG0spfic"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.1032.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.213.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.213.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xA1pJjD3OkXXDc/aFnMZyWaQpeig6v0sIWD+yD2g2tZ9cHGh8MDmPsnQew+ozw/Z
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.213.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.213.0/index.min.mjs": "sha384-xA1pJjD3OkXXDc/aFnMZyWaQpeig6v0sIWD+yD2g2tZ9cHGh8MDmPsnQew+ozw/Z"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.213.0/LICENSE
```

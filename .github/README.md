...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.637.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.637.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MZCpniUdnzPMvPvzoMma3pbjHocIEroxi7Nx7qxPcL32c5+sJXT1btKWIKrA3bBi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.637.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.637.0/index.min.mjs": "sha384-MZCpniUdnzPMvPvzoMma3pbjHocIEroxi7Nx7qxPcL32c5+sJXT1btKWIKrA3bBi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.637.0/LICENSE
```

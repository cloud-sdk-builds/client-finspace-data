...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.470.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.470.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Mjv2HUDqJIToJCs5ql3QYmLk6PDIZqv2LNlHL6HtN/rDC3aq/Fp2p/MORteHEGg3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.470.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.470.0/index.min.mjs": "sha384-Mjv2HUDqJIToJCs5ql3QYmLk6PDIZqv2LNlHL6HtN/rDC3aq/Fp2p/MORteHEGg3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.470.0/LICENSE
```

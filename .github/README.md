...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.606.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.606.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hvYO2tQ6F3FDY/CokNWmZTVIttHXZZy4d6gC0LPbkrkqc7Li7eeoOp6eu36i7eFM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.606.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.606.0/index.min.mjs": "sha384-hvYO2tQ6F3FDY/CokNWmZTVIttHXZZy4d6gC0LPbkrkqc7Li7eeoOp6eu36i7eFM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.606.0/LICENSE
```

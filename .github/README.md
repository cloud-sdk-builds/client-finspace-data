...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.197.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.197.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Jrz71B2mWiSqXdA693dfbVuR0R22jJc502h6tzzzwKbNjgygQJ8lDdtbmIE1ctK3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.197.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.197.0/index.min.mjs": "sha384-Jrz71B2mWiSqXdA693dfbVuR0R22jJc502h6tzzzwKbNjgygQJ8lDdtbmIE1ctK3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.197.0/LICENSE
```

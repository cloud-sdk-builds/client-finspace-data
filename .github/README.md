...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.863.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.863.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XM4YARc8vPwpX8EuV7N2pDyvPaAUEUJzsxwyx46N5CXCD+UX6KVMRfjU6K34YpPv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.863.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.863.0/index.min.mjs": "sha384-XM4YARc8vPwpX8EuV7N2pDyvPaAUEUJzsxwyx46N5CXCD+UX6KVMRfjU6K34YpPv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.863.0/LICENSE
```

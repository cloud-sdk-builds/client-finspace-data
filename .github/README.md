...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.226.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.226.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-x52vMtFedYJA1b0Cvc1zKfMmxcu4FftQO2qeDOAF7sOE+uvzC/TyM13NdQvzBCAH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.226.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.226.0/index.min.mjs": "sha384-x52vMtFedYJA1b0Cvc1zKfMmxcu4FftQO2qeDOAF7sOE+uvzC/TyM13NdQvzBCAH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.226.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.370.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.370.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qP16XwUuretC5uU2FP37GIKlm7YxyuT/GpPA7SlbM8pgihqXFW4BDQ7pweQo0lli
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.370.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.370.0/index.min.mjs": "sha384-qP16XwUuretC5uU2FP37GIKlm7YxyuT/GpPA7SlbM8pgihqXFW4BDQ7pweQo0lli"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.370.0/LICENSE
```

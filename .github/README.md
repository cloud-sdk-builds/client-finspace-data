...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.989.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.989.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-J3r3RcrcRpG0dMmpPObCfSoZgVaMooGUXEm8Ik13I4r+WUk4ewr1e89v5e/tLezP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.989.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.989.0/index.min.mjs": "sha384-J3r3RcrcRpG0dMmpPObCfSoZgVaMooGUXEm8Ik13I4r+WUk4ewr1e89v5e/tLezP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.989.0/LICENSE
```

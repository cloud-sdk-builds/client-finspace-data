...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.192.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.192.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-EwOdteHPaqJafdX+g9xh1e2zgiadeHLwscKmo2Pgqn+aVXI1POYW4ewOguJHbFLc
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.192.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.192.0/index.min.mjs": "sha384-EwOdteHPaqJafdX+g9xh1e2zgiadeHLwscKmo2Pgqn+aVXI1POYW4ewOguJHbFLc"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.192.0/LICENSE
```

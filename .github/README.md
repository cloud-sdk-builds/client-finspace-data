...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.986.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.986.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-v03747QwPha9NPYxfb5XQ2F7Hk3awrJDq1mJo23asMbA5yehbX6xF0jkh5+qM6/U
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.986.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.986.0/index.min.mjs": "sha384-v03747QwPha9NPYxfb5XQ2F7Hk3awrJDq1mJo23asMbA5yehbX6xF0jkh5+qM6/U"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.986.0/LICENSE
```

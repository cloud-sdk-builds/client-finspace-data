...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.198.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.198.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Cfwea5o2gpOfzpn7CI2Qvx5lkVCW9YG4cDyl7MRaUBycA2nCJ7fAB45zEp/BySZX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.198.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.198.0/index.min.mjs": "sha384-Cfwea5o2gpOfzpn7CI2Qvx5lkVCW9YG4cDyl7MRaUBycA2nCJ7fAB45zEp/BySZX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.198.0/LICENSE
```

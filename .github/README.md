...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.846.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.846.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xdq5G+Q2ZWaqzvYayUGXO1MNRLydCPy1LRWCtg/Rdq3rzw05IjWZxW/QE5g1bDJ6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.846.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.846.0/index.min.mjs": "sha384-xdq5G+Q2ZWaqzvYayUGXO1MNRLydCPy1LRWCtg/Rdq3rzw05IjWZxW/QE5g1bDJ6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.846.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.72.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.72.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PjA7CbWv5Dca9eDjdEi3HbdMly4n6Yfd+0RzzXpTXDaOhpZyV/lKOiJ/aVrp8Rtg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.72.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.72.0/index.min.mjs": "sha384-PjA7CbWv5Dca9eDjdEi3HbdMly4n6Yfd+0RzzXpTXDaOhpZyV/lKOiJ/aVrp8Rtg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.72.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.75.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.75.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yY1AzHySBo2jyF0biHIDTBnRFqGlML9Rs/F2bXDO4xwNA5bI3c4MWRa6t1i/iwii
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.75.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.75.0/index.min.mjs": "sha384-yY1AzHySBo2jyF0biHIDTBnRFqGlML9Rs/F2bXDO4xwNA5bI3c4MWRa6t1i/iwii"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.75.0/LICENSE
```

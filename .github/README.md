...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.804.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.804.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-X+iH7fzu2R/tJcxvXxXKCBFMfJAr1Uy/N3JuCZP/aDoDuLc7D2jOFsxZ9RrHWXPm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.804.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.804.0/index.min.mjs": "sha384-X+iH7fzu2R/tJcxvXxXKCBFMfJAr1Uy/N3JuCZP/aDoDuLc7D2jOFsxZ9RrHWXPm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.804.0/LICENSE
```

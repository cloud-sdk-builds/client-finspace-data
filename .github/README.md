...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.419.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.419.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vT2t+ISFNKQW2Hd0Z8tj3MVVW46ytAyxNsQndu4clEkfVkX5/fJ0R3dfUfnWqXdw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.419.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.419.0/index.min.mjs": "sha384-vT2t+ISFNKQW2Hd0Z8tj3MVVW46ytAyxNsQndu4clEkfVkX5/fJ0R3dfUfnWqXdw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.419.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.241.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.241.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BATvHhDIRuVLZEKf3sm27Xzalvwa2tu6MQHSvqUll6ZOY2ldZW2Zh/dtLYSw1sSb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.241.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.241.0/index.min.mjs": "sha384-BATvHhDIRuVLZEKf3sm27Xzalvwa2tu6MQHSvqUll6ZOY2ldZW2Zh/dtLYSw1sSb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.241.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.112.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.112.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tLsBSfJG+P4njQFLB8ih5zyxonhJNnfB3g5mfKoR452fe0TO/PR5NJxM0uOluEQ2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.112.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.112.0/index.min.mjs": "sha384-tLsBSfJG+P4njQFLB8ih5zyxonhJNnfB3g5mfKoR452fe0TO/PR5NJxM0uOluEQ2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.112.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.777.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.777.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CghaOAEQbe4geH/c5sA2qwq4z6fgb/iajikgWxDmJa4BAFYyl0QdxzgCewDk3a03
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.777.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.777.0/index.min.mjs": "sha384-CghaOAEQbe4geH/c5sA2qwq4z6fgb/iajikgWxDmJa4BAFYyl0QdxzgCewDk3a03"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.777.0/LICENSE
```

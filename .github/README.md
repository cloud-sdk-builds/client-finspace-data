...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.150.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.150.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vKaqq4b9lwJKAgUHJGysruypc6rAHooGjoPPPXTxnqhGQfm4Nr1CB9HIS268QmxW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.150.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.150.0/index.min.mjs": "sha384-vKaqq4b9lwJKAgUHJGysruypc6rAHooGjoPPPXTxnqhGQfm4Nr1CB9HIS268QmxW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.150.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.293.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.293.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MCIdXDwk4JnJWXkfIVwXI76AMChc65SqJVeF3/TvWBQgi68cAz+qwIaxVo0TC59S
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.293.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.293.0/index.min.mjs": "sha384-MCIdXDwk4JnJWXkfIVwXI76AMChc65SqJVeF3/TvWBQgi68cAz+qwIaxVo0TC59S"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.293.0/LICENSE
```

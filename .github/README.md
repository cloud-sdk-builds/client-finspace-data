...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.200.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.200.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aqTV4GkkWOhw4V8tw6Vdi9pRZVq9flklE47EAiv3DoHGpszt5OXn65B75cojnwWB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.200.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.200.0/index.min.mjs": "sha384-aqTV4GkkWOhw4V8tw6Vdi9pRZVq9flklE47EAiv3DoHGpszt5OXn65B75cojnwWB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.200.0/LICENSE
```

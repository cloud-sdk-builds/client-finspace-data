...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.1128.0).
...
- @aws-sdk/client-finspace-data v3.1128.0 - [https://cloud-sdk-builds.github.io/?sdk=client-finspace-data&version=3.1128.0](https://cloud-sdk-builds.github.io/?sdk=client-finspace-data&version=3.1128.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1128.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-c1yNuYJSH/yXlEJuVNLO9jWnjs5T6V5zYbZMwS6kE8VTAYFVLKx+RJrgZcQvNoJV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1128.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1128.0/index.min.mjs": "sha384-c1yNuYJSH/yXlEJuVNLO9jWnjs5T6V5zYbZMwS6kE8VTAYFVLKx+RJrgZcQvNoJV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.1128.0/LICENSE
```

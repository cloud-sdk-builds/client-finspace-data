...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.1057.0).
...
- @aws-sdk/client-finspace-data v3.1057.0 - [https://cloud-sdk-builds.github.io/?sdk=client-finspace-data&version=3.1057.0](https://cloud-sdk-builds.github.io/?sdk=client-finspace-data&version=3.1057.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1057.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-t1hwPELEtMlMIIJJ+wt6UdLEBxhSldRNhXzya5GqSUXmwOWNbE01/2vjneA92McE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1057.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1057.0/index.min.mjs": "sha384-t1hwPELEtMlMIIJJ+wt6UdLEBxhSldRNhXzya5GqSUXmwOWNbE01/2vjneA92McE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.1057.0/LICENSE
```

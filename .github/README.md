...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.1043.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1043.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XLvdqFF1tgLZVPbKtzZTlDQNJsga4bW5hOqwpyUqIxp7c6Df3a5aWKXWeD0XZ9U/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1043.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1043.0/index.min.mjs": "sha384-XLvdqFF1tgLZVPbKtzZTlDQNJsga4bW5hOqwpyUqIxp7c6Df3a5aWKXWeD0XZ9U/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.1043.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.477.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.477.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gdxo1eCuOpACr3JVhVYgx78iCmmR9bnepIm2lh1lhCgYpepOr1wwBh3eRPvWhtf8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.477.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.477.0/index.min.mjs": "sha384-gdxo1eCuOpACr3JVhVYgx78iCmmR9bnepIm2lh1lhCgYpepOr1wwBh3eRPvWhtf8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.477.0/LICENSE
```

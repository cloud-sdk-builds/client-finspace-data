...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.981.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.981.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YCRp3r2YHFEAhAD8MPErV60AEwxtNmn9jW2dftTTj7O3+KkNNy6zzOXo0xYSB6in
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.981.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.981.0/index.min.mjs": "sha384-YCRp3r2YHFEAhAD8MPErV60AEwxtNmn9jW2dftTTj7O3+KkNNy6zzOXo0xYSB6in"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.981.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.1117.0).
...
- @aws-sdk/client-finspace-data v3.1117.0 - [https://cloud-sdk-builds.github.io/?sdk=client-finspace-data&version=3.1117.0](https://cloud-sdk-builds.github.io/?sdk=client-finspace-data&version=3.1117.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1117.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nJ6GtaonEokO8lIzldGul7bDVKViEHSInkS0bOHt6kUonW2+Nob7SCwYFiwbTBck
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1117.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1117.0/index.min.mjs": "sha384-nJ6GtaonEokO8lIzldGul7bDVKViEHSInkS0bOHt6kUonW2+Nob7SCwYFiwbTBck"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.1117.0/LICENSE
```

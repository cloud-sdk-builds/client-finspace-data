...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.33.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.33.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-iSBZPpkgZu4hEn5WvXIsm4HOhB8vGdAsfXO89smqdtd+j/e6LAPmarW9NK3pGN+F
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.33.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.33.0/index.min.mjs": "sha384-iSBZPpkgZu4hEn5WvXIsm4HOhB8vGdAsfXO89smqdtd+j/e6LAPmarW9NK3pGN+F"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.33.0/LICENSE
```

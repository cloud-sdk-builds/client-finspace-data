...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.855.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.855.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-t4/TpJsZqRbPcoEnj4I6hP5mS7ywmG7EJgvbsMwFvzdrm54SpPdzjziT7+RwFXPJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.855.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.855.0/index.min.mjs": "sha384-t4/TpJsZqRbPcoEnj4I6hP5mS7ywmG7EJgvbsMwFvzdrm54SpPdzjziT7+RwFXPJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.855.0/LICENSE
```

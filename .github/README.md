...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.178.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.178.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fQqUf8v9grhQIhTBiHGXn/Ro7BpXPgn0vjhhW2xm+soSeqwLbpczrL51qI6ahrlK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.178.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.178.0/index.min.mjs": "sha384-fQqUf8v9grhQIhTBiHGXn/Ro7BpXPgn0vjhhW2xm+soSeqwLbpczrL51qI6ahrlK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.178.0/LICENSE
```

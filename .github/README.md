...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.743.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.743.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YlEOowXc2tCDMGCc19O3QU2YVC52yOxFoISYXSuBx4W4sBlQkHMGZpRBLaITOfLL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.743.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.743.0/index.min.mjs": "sha384-YlEOowXc2tCDMGCc19O3QU2YVC52yOxFoISYXSuBx4W4sBlQkHMGZpRBLaITOfLL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.743.0/LICENSE
```

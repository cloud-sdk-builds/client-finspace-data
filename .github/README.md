...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.1042.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1042.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VPhqlsP38FZVOfzoqL7SYqXfZYZq0bkxG+/74X09XBEkmaCu2QQQp8uCoS9k2IVg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1042.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1042.0/index.min.mjs": "sha384-VPhqlsP38FZVOfzoqL7SYqXfZYZq0bkxG+/74X09XBEkmaCu2QQQp8uCoS9k2IVg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.1042.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.929.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.929.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZxI9FWQWBdXifjrZyGtOkRoqzDLgHmwUg3uU2Xb7yUw28n+NaaZEgP8lEB1Vmdaw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.929.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.929.0/index.min.mjs": "sha384-ZxI9FWQWBdXifjrZyGtOkRoqzDLgHmwUg3uU2Xb7yUw28n+NaaZEgP8lEB1Vmdaw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.929.0/LICENSE
```

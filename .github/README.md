...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.386.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.386.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-iB62qC2zd+79TaDj1qhcRRf0o6K3+e4Ph7gjcp90HPAREiAHWKD4StkRevlXlPzw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.386.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.386.0/index.min.mjs": "sha384-iB62qC2zd+79TaDj1qhcRRf0o6K3+e4Ph7gjcp90HPAREiAHWKD4StkRevlXlPzw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.386.0/LICENSE
```

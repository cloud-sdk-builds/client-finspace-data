...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.481.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.481.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-sxuHj9Aojv3OrtCbWeWg0YjjxxzdUwtZ8JMmzb9f1iD6BouxyiQuwUE6hhLljerO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.481.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.481.0/index.min.mjs": "sha384-sxuHj9Aojv3OrtCbWeWg0YjjxxzdUwtZ8JMmzb9f1iD6BouxyiQuwUE6hhLljerO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.481.0/LICENSE
```

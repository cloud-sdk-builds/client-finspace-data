...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.159.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.159.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-NCuDxsCQ+SNvavvJkIFacajRlyECGsQ1Upp3UCW/a82jurb7FNMN4f4srYKERzWW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.159.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.159.0/index.min.mjs": "sha384-NCuDxsCQ+SNvavvJkIFacajRlyECGsQ1Upp3UCW/a82jurb7FNMN4f4srYKERzWW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.159.0/LICENSE
```

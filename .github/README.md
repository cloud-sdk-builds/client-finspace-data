...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.110.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.110.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5UX9PYCN1OIZJjmX9+/NIlxDcBSI/STZdRIMKlqaM6iScdLUjDEp83xcz0UHqCgx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.110.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.110.0/index.min.mjs": "sha384-5UX9PYCN1OIZJjmX9+/NIlxDcBSI/STZdRIMKlqaM6iScdLUjDEp83xcz0UHqCgx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.110.0/LICENSE
```

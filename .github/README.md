...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.796.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.796.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Xex0EIQ+g7IsfrvvyVTqoKT1L/RrwzpF+4JsJg+o2jbHiXZWBCx4cmnGuYzYjgNd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.796.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.796.0/index.min.mjs": "sha384-Xex0EIQ+g7IsfrvvyVTqoKT1L/RrwzpF+4JsJg+o2jbHiXZWBCx4cmnGuYzYjgNd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.796.0/LICENSE
```

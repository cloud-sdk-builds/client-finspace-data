...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.982.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.982.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-KJ7qAHQDXY6riqeFyJjgZfWMm/+qQZRzUSGy0bHX0moB8VKeIwrrSxfF06rfuLU8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.982.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.982.0/index.min.mjs": "sha384-KJ7qAHQDXY6riqeFyJjgZfWMm/+qQZRzUSGy0bHX0moB8VKeIwrrSxfF06rfuLU8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.982.0/LICENSE
```

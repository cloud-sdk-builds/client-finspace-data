...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.405.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.405.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-H/NhEuYz++q+Qe0jk1IMcUZu9pz28qxWBHxZxgIRTHdFAyBIWhOE4Y+vP0ZheYtV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.405.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.405.0/index.min.mjs": "sha384-H/NhEuYz++q+Qe0jk1IMcUZu9pz28qxWBHxZxgIRTHdFAyBIWhOE4Y+vP0ZheYtV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.405.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.234.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.234.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YCCsoi797GHt9TRTdltCqtRJ02/Emjr0z3miP+J2BBb62J+o7ad00sR4iY+sFdHS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.234.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.234.0/index.min.mjs": "sha384-YCCsoi797GHt9TRTdltCqtRJ02/Emjr0z3miP+J2BBb62J+o7ad00sR4iY+sFdHS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.234.0/LICENSE
```

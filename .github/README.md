...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.848.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.848.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fl+tm0z+ZcsSs0DAgCoyzKEc8nxUrh0pRfwO3RBZpz2JwD6mM2RkJ3dokK7D21Z/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.848.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.848.0/index.min.mjs": "sha384-fl+tm0z+ZcsSs0DAgCoyzKEc8nxUrh0pRfwO3RBZpz2JwD6mM2RkJ3dokK7D21Z/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.848.0/LICENSE
```

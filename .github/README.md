...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.564.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.564.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-W6GIBXf7joGWVdztFD/DUcuFhPw37PXL8tL5zj5V8wFf1BvfoK77y55vCKeP/erg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.564.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.564.0/index.min.mjs": "sha384-W6GIBXf7joGWVdztFD/DUcuFhPw37PXL8tL5zj5V8wFf1BvfoK77y55vCKeP/erg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.564.0/LICENSE
```

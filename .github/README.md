...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.54.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.54.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-wgDCzLyWdkv/5s3rgdCc2WfbI19BxTRpXZL+0j/LDlHRbrrM08ZEJDD3hGWoYjeU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.54.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.54.1/index.min.mjs": "sha384-wgDCzLyWdkv/5s3rgdCc2WfbI19BxTRpXZL+0j/LDlHRbrrM08ZEJDD3hGWoYjeU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.54.1/LICENSE
```

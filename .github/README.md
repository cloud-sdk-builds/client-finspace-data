...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.82.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.82.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LdoexEjRfqv+Zu/or+2s4RCvcOWZbn6A65Zbu10MHJdqiLBE+XwR48sJXvIN2zL3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.82.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.82.0/index.min.mjs": "sha384-LdoexEjRfqv+Zu/or+2s4RCvcOWZbn6A65Zbu10MHJdqiLBE+XwR48sJXvIN2zL3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.82.0/LICENSE
```

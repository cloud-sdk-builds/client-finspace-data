...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.567.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.567.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aSNz7VC23i6kVJyf4BEt2MOr27UtSPjwCr2d0tPm/w8E7C2alfGFYzVK0elvHMVP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.567.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.567.0/index.min.mjs": "sha384-aSNz7VC23i6kVJyf4BEt2MOr27UtSPjwCr2d0tPm/w8E7C2alfGFYzVK0elvHMVP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.567.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.47.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.47.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LZdydNBKpb//v8U+KjfBlf9rLx7Y+oRwPxJqQxcIuUH2Suq4vWOVaHurwMU+2Lw9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.47.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.47.0/index.min.mjs": "sha384-LZdydNBKpb//v8U+KjfBlf9rLx7Y+oRwPxJqQxcIuUH2Suq4vWOVaHurwMU+2Lw9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.47.0/LICENSE
```

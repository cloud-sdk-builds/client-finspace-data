...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.730.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.730.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QnFct1HUSdBqRWfvJG5dkyCTJCG8v/2cA0/BKTvHUJy01prVXM5TDyj1rpUbJYG8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.730.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.730.0/index.min.mjs": "sha384-QnFct1HUSdBqRWfvJG5dkyCTJCG8v/2cA0/BKTvHUJy01prVXM5TDyj1rpUbJYG8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.730.0/LICENSE
```

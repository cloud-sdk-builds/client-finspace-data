...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.966.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.966.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uPIVaWq3GfjaSAllPs077GOsUuPlpieNv5hH1yvEFuyrwl4/a9QRElOXm+bhrTlR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.966.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.966.0/index.min.mjs": "sha384-uPIVaWq3GfjaSAllPs077GOsUuPlpieNv5hH1yvEFuyrwl4/a9QRElOXm+bhrTlR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.966.0/LICENSE
```

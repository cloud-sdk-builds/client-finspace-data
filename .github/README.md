...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.1007.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1007.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ejO9F7KbNnv6bBoZBrHhy6tMMSnRTMKx/FYCse/br6bX96mogNOfZ1yeXFa9q8HW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1007.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1007.0/index.min.mjs": "sha384-ejO9F7KbNnv6bBoZBrHhy6tMMSnRTMKx/FYCse/br6bX96mogNOfZ1yeXFa9q8HW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.1007.0/LICENSE
```

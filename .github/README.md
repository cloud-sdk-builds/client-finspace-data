...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.74.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.74.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-t0RUv4iuOv8X227AXDMPD9qS6uQx58xYwGQslaFhMHxzwiLmC/K9IA6WS1Pvulek
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.74.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.74.0/index.min.mjs": "sha384-t0RUv4iuOv8X227AXDMPD9qS6uQx58xYwGQslaFhMHxzwiLmC/K9IA6WS1Pvulek"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.74.0/LICENSE
```

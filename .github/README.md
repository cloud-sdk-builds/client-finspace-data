...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.445.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.445.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-R/SeUoqJeZvfLuhv5BMmvZhnI0KAn00doG8Ws/azUJ9YzEp5RYDsVeXLfXvhdCWw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.445.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.445.0/index.min.mjs": "sha384-R/SeUoqJeZvfLuhv5BMmvZhnI0KAn00doG8Ws/azUJ9YzEp5RYDsVeXLfXvhdCWw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.445.0/LICENSE
```

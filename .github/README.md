...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.664.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.664.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Ql7tujEHdyf2m0esP8fBzHiAIrxOXFkwInAzTv3t91FMUwERNEUzvitKlE1ct3aT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.664.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.664.0/index.min.mjs": "sha384-Ql7tujEHdyf2m0esP8fBzHiAIrxOXFkwInAzTv3t91FMUwERNEUzvitKlE1ct3aT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.664.0/LICENSE
```

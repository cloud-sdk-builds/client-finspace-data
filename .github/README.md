...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.997.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.997.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3oJAthqmwhJl5McaSKB7K7hUJfiQrJNgZG85oGGIXEkPWCQ3bln+Ot4dupoDPFsf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.997.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.997.0/index.min.mjs": "sha384-3oJAthqmwhJl5McaSKB7K7hUJfiQrJNgZG85oGGIXEkPWCQ3bln+Ot4dupoDPFsf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.997.0/LICENSE
```

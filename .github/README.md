...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.301.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.301.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bBjYQObudDelzuI8zziRWycUy6faIGrWTBhSArHfuHVAh7zKyVrq6d0iKhIA0YW7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.301.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.301.0/index.min.mjs": "sha384-bBjYQObudDelzuI8zziRWycUy6faIGrWTBhSArHfuHVAh7zKyVrq6d0iKhIA0YW7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.301.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.858.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.858.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-D1LMHy0P3vgoXfpzuN3SJEUuXVEP+BE7dqXL3ae0EVnx/ET5W4rZH+3cO4t27qV9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.858.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.858.0/index.min.mjs": "sha384-D1LMHy0P3vgoXfpzuN3SJEUuXVEP+BE7dqXL3ae0EVnx/ET5W4rZH+3cO4t27qV9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.858.0/LICENSE
```

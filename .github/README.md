...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.590.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.590.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LyEhfs4h1SDWxeNd+Io8ME952SCD2WEjiR513U70zcqIkyr2czYWn86gnFV8xm5V
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.590.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.590.0/index.min.mjs": "sha384-LyEhfs4h1SDWxeNd+Io8ME952SCD2WEjiR513U70zcqIkyr2czYWn86gnFV8xm5V"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.590.0/LICENSE
```

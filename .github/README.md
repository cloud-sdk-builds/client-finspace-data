...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.529.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.529.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-zu5sTnBGhpKHcbJk3ZctDuAiwPaCzJ/d0CIfviXl2Hpjq/Sq9mP87eiAKyLPkR1U
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.529.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.529.1/index.min.mjs": "sha384-zu5sTnBGhpKHcbJk3ZctDuAiwPaCzJ/d0CIfviXl2Hpjq/Sq9mP87eiAKyLPkR1U"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.529.1/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.266.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.266.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-lM4WSZCq7M6Bbe0WKz4tlCYNBc0VHHuIIEGAmk0FHvSwpDVe4q7dAGLQwZB2o0rO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.266.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.266.1/index.min.mjs": "sha384-lM4WSZCq7M6Bbe0WKz4tlCYNBc0VHHuIIEGAmk0FHvSwpDVe4q7dAGLQwZB2o0rO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.266.1/LICENSE
```

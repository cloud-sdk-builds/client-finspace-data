...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.654.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.654.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cSfbEh/fP/hyUbkDwuXfN3p7b0utyxacml6dgPBVCJVg8LyPN4WNXcuXqVQF0QKZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.654.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.654.0/index.min.mjs": "sha384-cSfbEh/fP/hyUbkDwuXfN3p7b0utyxacml6dgPBVCJVg8LyPN4WNXcuXqVQF0QKZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.654.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.845.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.845.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MTzlFX4RubPQ2nIJnxqcSg14oQCQdRwd6xZP65Z7fqwQbMZVhbZkVK2smCuE0u7Z
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.845.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.845.0/index.min.mjs": "sha384-MTzlFX4RubPQ2nIJnxqcSg14oQCQdRwd6xZP65Z7fqwQbMZVhbZkVK2smCuE0u7Z"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.845.0/LICENSE
```

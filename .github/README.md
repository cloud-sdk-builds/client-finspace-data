...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.600.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.600.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/uipcGIZ4Re5WJbMkrW5etaleu2R4ldlOOMpDhhhjOZx8Us17ilAbWXQ5OGtY/Ut
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.600.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.600.0/index.min.mjs": "sha384-/uipcGIZ4Re5WJbMkrW5etaleu2R4ldlOOMpDhhhjOZx8Us17ilAbWXQ5OGtY/Ut"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.600.0/LICENSE
```

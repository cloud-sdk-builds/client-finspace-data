...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.121.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.121.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-e3rBnyNdacs0mEM8HgJM5I2qxnniY8l1CwGRCT4B2wzMaSxbbiJ62VEoSomEKozK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.121.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.121.0/index.min.mjs": "sha384-e3rBnyNdacs0mEM8HgJM5I2qxnniY8l1CwGRCT4B2wzMaSxbbiJ62VEoSomEKozK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.121.0/LICENSE
```

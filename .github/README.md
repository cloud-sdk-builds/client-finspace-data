...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.254.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.254.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VACQf8IktofWr8E2I8ZMyD9aXbpuCxrMbMmzGSt+pQ5fzVBEuwGlJSDquJ4tc7Wb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.254.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.254.0/index.min.mjs": "sha384-VACQf8IktofWr8E2I8ZMyD9aXbpuCxrMbMmzGSt+pQ5fzVBEuwGlJSDquJ4tc7Wb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.254.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.995.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.995.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-f5FesFRDNf5yYlVA/FdO7zR6VMVE8c722qaP04w74QtRftdaz1HDGgQGs/Uo/4fH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.995.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.995.0/index.min.mjs": "sha384-f5FesFRDNf5yYlVA/FdO7zR6VMVE8c722qaP04w74QtRftdaz1HDGgQGs/Uo/4fH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.995.0/LICENSE
```

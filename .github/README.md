...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.879.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.879.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aF1VO8bcOnUxpMxH/iS2x+EEv3n3Ywbwo9pvXDkNYneQaOOAL2fv4762hifk/FrC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.879.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.879.0/index.min.mjs": "sha384-aF1VO8bcOnUxpMxH/iS2x+EEv3n3Ywbwo9pvXDkNYneQaOOAL2fv4762hifk/FrC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.879.0/LICENSE
```

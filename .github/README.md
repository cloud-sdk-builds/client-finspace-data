...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.34.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.34.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AZYm7o1VDI5glakoo8UdR9qAwNKjN/3IHHuuy51+OhgtR8e4IyZzWyWla/kp+BRL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.34.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.34.0/index.min.mjs": "sha384-AZYm7o1VDI5glakoo8UdR9qAwNKjN/3IHHuuy51+OhgtR8e4IyZzWyWla/kp+BRL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.34.0/LICENSE
```

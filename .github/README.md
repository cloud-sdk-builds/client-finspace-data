...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.556.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.556.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-s8MM2FYyVsSnAbw5E7cEpLoaKT474oeqCD3FDFrUCPqd84+KcTL3zc2+xvKASc2d
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.556.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.556.0/index.min.mjs": "sha384-s8MM2FYyVsSnAbw5E7cEpLoaKT474oeqCD3FDFrUCPqd84+KcTL3zc2+xvKASc2d"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.556.0/LICENSE
```

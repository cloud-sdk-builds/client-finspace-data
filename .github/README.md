...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.920.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.920.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-b7jLuGoxbEhhaeGzM4fPQ4hEmFoZtxbD9SZteMspXk/ABZDKHTOLLtXnx2Y5POBz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.920.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.920.0/index.min.mjs": "sha384-b7jLuGoxbEhhaeGzM4fPQ4hEmFoZtxbD9SZteMspXk/ABZDKHTOLLtXnx2Y5POBz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.920.0/LICENSE
```

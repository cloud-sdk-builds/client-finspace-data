...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.825.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.825.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CS/PK6UzRbcyc4/eSj61LOIDL7tNM9mX4+W8eJ/xa+tS7XNNreVqVeNSfo36GjON
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.825.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.825.0/index.min.mjs": "sha384-CS/PK6UzRbcyc4/eSj61LOIDL7tNM9mX4+W8eJ/xa+tS7XNNreVqVeNSfo36GjON"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.825.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.609.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.609.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GPy7mso+KarKoxL/HTS0byqgH3brMKnE38j2eyYUPY7EbRF+fui5aLEClOjNHcqO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.609.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.609.0/index.min.mjs": "sha384-GPy7mso+KarKoxL/HTS0byqgH3brMKnE38j2eyYUPY7EbRF+fui5aLEClOjNHcqO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.609.0/LICENSE
```

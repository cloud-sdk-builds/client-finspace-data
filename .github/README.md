...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.577.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.577.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UhDj/1dHqzRfbP4P0Fq9NzxKgmi+7iXs867+buaJ2dNZS6mLQLV82AA455NS+Cgd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.577.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.577.0/index.min.mjs": "sha384-UhDj/1dHqzRfbP4P0Fq9NzxKgmi+7iXs867+buaJ2dNZS6mLQLV82AA455NS+Cgd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.577.0/LICENSE
```

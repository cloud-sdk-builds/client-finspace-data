...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.20.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.20.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mQ/9i72EANlWAM1FwSBGDwZF8bNXRCAPgya0mNWh4RSqwNDZGSr0m9n9qqt/5yV1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.20.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.20.0/index.min.mjs": "sha384-mQ/9i72EANlWAM1FwSBGDwZF8bNXRCAPgya0mNWh4RSqwNDZGSr0m9n9qqt/5yV1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.20.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.839.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.839.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-CKXSKDZcVCyVJhP9XWcSHbYvOpp8CkZ3evXqH9210gy2MQ2m4S3USlFDIHLk6ph/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.839.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.839.0/index.min.mjs": "sha384-CKXSKDZcVCyVJhP9XWcSHbYvOpp8CkZ3evXqH9210gy2MQ2m4S3USlFDIHLk6ph/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.839.0/LICENSE
```

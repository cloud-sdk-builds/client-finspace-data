...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.118.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.118.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-07M5KHH5FmYqrAIPcFg5xKk/flsY0+1iaPCnr7y0T/WzZuZHN9fqZsr1NkeNfLvm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.118.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.118.0/index.min.mjs": "sha384-07M5KHH5FmYqrAIPcFg5xKk/flsY0+1iaPCnr7y0T/WzZuZHN9fqZsr1NkeNfLvm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.118.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.666.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.666.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-smQyq/Z3hKJVSpPj6PWkYGoIpVdOBmmaQQmPDeGOS9jCqfTAEwgm6+Gc8yXtGZjW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.666.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.666.0/index.min.mjs": "sha384-smQyq/Z3hKJVSpPj6PWkYGoIpVdOBmmaQQmPDeGOS9jCqfTAEwgm6+Gc8yXtGZjW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.666.0/LICENSE
```

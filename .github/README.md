...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.193.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.193.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HBMbTlp6J768HK30u+x2RRs+KmrkuGTMy1aiU28oSZLQjzsDJ8n02MjLvsQ2mJ6C
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.193.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.193.0/index.min.mjs": "sha384-HBMbTlp6J768HK30u+x2RRs+KmrkuGTMy1aiU28oSZLQjzsDJ8n02MjLvsQ2mJ6C"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.193.0/LICENSE
```

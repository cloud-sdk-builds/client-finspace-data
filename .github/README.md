...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.731.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.731.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-PfB+FOL5XP0JvN0U6dpbH95vPhocAaQkJ060Po9SXlUeZJ79EgP5VMm9kEq3KlgM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.731.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.731.1/index.min.mjs": "sha384-PfB+FOL5XP0JvN0U6dpbH95vPhocAaQkJ060Po9SXlUeZJ79EgP5VMm9kEq3KlgM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.731.1/LICENSE
```

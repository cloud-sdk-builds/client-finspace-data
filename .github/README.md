...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.24.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.24.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1pxICsQcwOR79SwyZCi4K6SE0NhUFwRHc5rD/PaIOxUnRD6Mx89bCmuQmG2rWYho
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.24.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.24.0/index.min.mjs": "sha384-1pxICsQcwOR79SwyZCi4K6SE0NhUFwRHc5rD/PaIOxUnRD6Mx89bCmuQmG2rWYho"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.24.0/LICENSE
```

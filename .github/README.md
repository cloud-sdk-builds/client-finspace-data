...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.569.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.569.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0TonmWKzYbBxEsUcjmHv8Jf5H2pNfWA0tUseZDIvBvpCt5TTa9hQhMkOswoOpyKN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.569.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.569.0/index.min.mjs": "sha384-0TonmWKzYbBxEsUcjmHv8Jf5H2pNfWA0tUseZDIvBvpCt5TTa9hQhMkOswoOpyKN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.569.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.840.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.840.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HqghNtImYjQsyKyRHQIWEQBxLYsMcScQo2gpKwaQSq9zN9hY40/h5+t5jTPjgkBr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.840.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.840.0/index.min.mjs": "sha384-HqghNtImYjQsyKyRHQIWEQBxLYsMcScQo2gpKwaQSq9zN9hY40/h5+t5jTPjgkBr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.840.0/LICENSE
```

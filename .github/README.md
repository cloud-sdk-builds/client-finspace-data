...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.983.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.983.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VhyYzBnJpP0iwKDW6Efn0kmYqII7O7kVOtbHrICqA9PJcDIflyFQQgArjhHNT3WU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.983.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.983.0/index.min.mjs": "sha384-VhyYzBnJpP0iwKDW6Efn0kmYqII7O7kVOtbHrICqA9PJcDIflyFQQgArjhHNT3WU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.983.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.358.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.358.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-8A85+N7I4irQMMaaPT8kg86UySNZTxMNmKRqbp9alZTGrrGO73ldMvvZVsuv1cBw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.358.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.358.0/index.min.mjs": "sha384-8A85+N7I4irQMMaaPT8kg86UySNZTxMNmKRqbp9alZTGrrGO73ldMvvZVsuv1cBw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.358.0/LICENSE
```

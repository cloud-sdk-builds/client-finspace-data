...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.478.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.478.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lck4bmDEi4aO+oQ5BAdke/JyVxFNU3N619r3lVlpYMW2GEP1AXt1kWtat1duO7dF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.478.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.478.0/index.min.mjs": "sha384-lck4bmDEi4aO+oQ5BAdke/JyVxFNU3N619r3lVlpYMW2GEP1AXt1kWtat1duO7dF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.478.0/LICENSE
```

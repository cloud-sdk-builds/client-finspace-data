...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.876.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.876.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZFLiBABzjHhAEEUPT2K+4H/xTy5BRddtFySol627lpQByGAO5OzMFxpC0kXfLy5A
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.876.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.876.0/index.min.mjs": "sha384-ZFLiBABzjHhAEEUPT2K+4H/xTy5BRddtFySol627lpQByGAO5OzMFxpC0kXfLy5A"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.876.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.926.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.926.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vKMFohcLy9uaQ+SAkQ8ned/WmT7Cv5thM8VnZ4I0KeOszqa4w/qua8Vmudop+CTT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.926.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.926.0/index.min.mjs": "sha384-vKMFohcLy9uaQ+SAkQ8ned/WmT7Cv5thM8VnZ4I0KeOszqa4w/qua8Vmudop+CTT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.926.0/LICENSE
```

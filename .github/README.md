...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.677.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.677.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZUUUOPuDyA8ZG7uSHdVGTwufGjHMi6jKvRh54la2Exnny1TUyKR0BsXFfgbg5DtQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.677.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.677.0/index.min.mjs": "sha384-ZUUUOPuDyA8ZG7uSHdVGTwufGjHMi6jKvRh54la2Exnny1TUyKR0BsXFfgbg5DtQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.677.0/LICENSE
```

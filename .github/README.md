...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.341.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.341.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dZg0unXitju0Ao8ZLXoYm8BxYwY1zGcG6pPiIqT5T4leCMG0+vFSikoFVUBechEo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.341.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.341.0/index.min.mjs": "sha384-dZg0unXitju0Ao8ZLXoYm8BxYwY1zGcG6pPiIqT5T4leCMG0+vFSikoFVUBechEo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.341.0/LICENSE
```

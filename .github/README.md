...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.67.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.67.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xm3UjBvnqhF6PVf+/MzDrr7ewgD7vJ/AbKLDUCaIc+J/Y1IVvEG6aYPUmhoWpRBk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.67.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.67.0/index.min.mjs": "sha384-xm3UjBvnqhF6PVf+/MzDrr7ewgD7vJ/AbKLDUCaIc+J/Y1IVvEG6aYPUmhoWpRBk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.67.0/LICENSE
```

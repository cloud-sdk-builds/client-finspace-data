...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.35.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.35.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2UZDkx5Fnje37mrY6mViCDSCtM2tOMd3ibHO2LJEE0KStY2OwUJayAH7BxwU4xaV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.35.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.35.0/index.min.mjs": "sha384-2UZDkx5Fnje37mrY6mViCDSCtM2tOMd3ibHO2LJEE0KStY2OwUJayAH7BxwU4xaV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.35.0/LICENSE
```

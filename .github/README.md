...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.964.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.964.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6hqF7SFcuCuKNjpVaOTXgluWQXuP1UC61xPv502E9nCsLdgjSBqpPw+xWMaYQCYK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.964.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.964.0/index.min.mjs": "sha384-6hqF7SFcuCuKNjpVaOTXgluWQXuP1UC61xPv502E9nCsLdgjSBqpPw+xWMaYQCYK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.964.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.669.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.669.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UPTfaM92xVSvbJtj+znEGC58QWSw7sFY7L4W3/RImVyE74NI9mVSbP6vB9k1zHBJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.669.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.669.0/index.min.mjs": "sha384-UPTfaM92xVSvbJtj+znEGC58QWSw7sFY7L4W3/RImVyE74NI9mVSbP6vB9k1zHBJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.669.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.624.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.624.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JuDT+32PGERcTj72dgStZzXl3aQTgDYf0NsohS9NYQDXn1uJb7PVi7WT8OSvIv7B
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.624.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.624.0/index.min.mjs": "sha384-JuDT+32PGERcTj72dgStZzXl3aQTgDYf0NsohS9NYQDXn1uJb7PVi7WT8OSvIv7B"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.624.0/LICENSE
```

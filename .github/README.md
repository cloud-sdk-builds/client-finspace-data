...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.665.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.665.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-w5JLESE4UgYYvgT1IyOPk3wVaGYmCMJQ+bFW2Bo4g8ROHvr+LX6e1R2HZV6lVE1F
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.665.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.665.0/index.min.mjs": "sha384-w5JLESE4UgYYvgT1IyOPk3wVaGYmCMJQ+bFW2Bo4g8ROHvr+LX6e1R2HZV6lVE1F"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.665.0/LICENSE
```

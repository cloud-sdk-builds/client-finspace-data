...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.873.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.873.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3CX5w3sm2Vzqiwb7VyWJss5kdmXUvBg6rPPxAoCtt4PeLhlRWjwjx0itSwoNB+HW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.873.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.873.0/index.min.mjs": "sha384-3CX5w3sm2Vzqiwb7VyWJss5kdmXUvBg6rPPxAoCtt4PeLhlRWjwjx0itSwoNB+HW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.873.0/LICENSE
```

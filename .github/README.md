...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.738.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.738.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/ffvSKNbIy7phi65LIRk979PuOHECF2KeRWXgZShoc3vHpSbqlxdt+H28psoJ6FB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.738.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.738.0/index.min.mjs": "sha384-/ffvSKNbIy7phi65LIRk979PuOHECF2KeRWXgZShoc3vHpSbqlxdt+H28psoJ6FB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.738.0/LICENSE
```

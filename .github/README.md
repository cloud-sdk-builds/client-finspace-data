...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.335.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.335.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RiDudrxRyiRYiYcqT7W7YQqOD40ojznpSEo4mh7GYgV2xsNkWM4w+c1fE8Jst84O
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.335.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.335.0/index.min.mjs": "sha384-RiDudrxRyiRYiYcqT7W7YQqOD40ojznpSEo4mh7GYgV2xsNkWM4w+c1fE8Jst84O"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.335.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.552.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.552.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JAxNkQ+M5zHUq25P1pRuG5ckoIvlDS3qvf9gBDTbLdUXJx/x+Wml7NfUYgJWoaAG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.552.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.552.0/index.min.mjs": "sha384-JAxNkQ+M5zHUq25P1pRuG5ckoIvlDS3qvf9gBDTbLdUXJx/x+Wml7NfUYgJWoaAG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.552.0/LICENSE
```

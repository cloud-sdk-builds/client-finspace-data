...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.347.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.347.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-AtPvLLMPW1HaGSXjhJdeZiiv/pAVI830hAd736z0BdrL5+CUF/9RM1UX4Ye/hIXx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.347.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.347.1/index.min.mjs": "sha384-AtPvLLMPW1HaGSXjhJdeZiiv/pAVI830hAd736z0BdrL5+CUF/9RM1UX4Ye/hIXx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.347.1/LICENSE
```

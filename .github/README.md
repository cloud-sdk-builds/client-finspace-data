...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.398.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.398.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-EX0BGl4GaE//OwQ9YfBthCzgC+Xcgp4BSKJpUDDn2WXdO9LavYtUkz9I9LS7KIHs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.398.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.398.0/index.min.mjs": "sha384-EX0BGl4GaE//OwQ9YfBthCzgC+Xcgp4BSKJpUDDn2WXdO9LavYtUkz9I9LS7KIHs"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.398.0/LICENSE
```

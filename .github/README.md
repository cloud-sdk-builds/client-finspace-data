...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.686.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.686.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5SolGFYrFsywd6IfKtQ9oFVPpPiM4iLdIrOZ6dBOm3VyroAYThfCeZD1+4pcCF9k
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.686.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.686.0/index.min.mjs": "sha384-5SolGFYrFsywd6IfKtQ9oFVPpPiM4iLdIrOZ6dBOm3VyroAYThfCeZD1+4pcCF9k"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.686.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.183.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.183.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-p1WkUfx4+1VB77ofRtqCjI7e2RptjoED4y+PnmhjHEewoYW8ohvs/Uz7W8yglGDD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.183.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.183.0/index.min.mjs": "sha384-p1WkUfx4+1VB77ofRtqCjI7e2RptjoED4y+PnmhjHEewoYW8ohvs/Uz7W8yglGDD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.183.0/LICENSE
```

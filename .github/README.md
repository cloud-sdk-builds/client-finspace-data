...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.682.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.682.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/haCnt+TyTCdMkPs5TAoMTl0LSqo9eYn1luR6Xda/useBQtrB0O6fkcbjoXDOQUQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.682.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.682.0/index.min.mjs": "sha384-/haCnt+TyTCdMkPs5TAoMTl0LSqo9eYn1luR6Xda/useBQtrB0O6fkcbjoXDOQUQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.682.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.169.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.169.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Zc/o06oTSAJhKfCJX7d4q8MxoQojhbZ/dOpdtHjL8/FA+DsHYsgRtpNqxOimSA8e
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.169.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.169.0/index.min.mjs": "sha384-Zc/o06oTSAJhKfCJX7d4q8MxoQojhbZ/dOpdtHjL8/FA+DsHYsgRtpNqxOimSA8e"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.169.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.540.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.540.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VV+pa9EfQE4bD6iEiDOqxRDPh+65q+yTZxWgBdvJ3z1UZwcLPOmhXAN7QrBhpVGD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.540.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.540.0/index.min.mjs": "sha384-VV+pa9EfQE4bD6iEiDOqxRDPh+65q+yTZxWgBdvJ3z1UZwcLPOmhXAN7QrBhpVGD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.540.0/LICENSE
```

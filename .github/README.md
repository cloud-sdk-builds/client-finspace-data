...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.828.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.828.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZF9CJ2AuHkab1Rxw2STopAlrd83LbvcKrxrqmB9SqTgow4iwfuR4/CJY79s+YheD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.828.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.828.0/index.min.mjs": "sha384-ZF9CJ2AuHkab1Rxw2STopAlrd83LbvcKrxrqmB9SqTgow4iwfuR4/CJY79s+YheD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.828.0/LICENSE
```

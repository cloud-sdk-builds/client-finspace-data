...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.47.2).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.47.2/index.min.mjs
```

SRI SHA Hash

```text
sha384-eMi8OLwFpGrgtkduT+lYkI2Jfci1BtcHk+3F5s69AsT0OpJ+rphWpMSiMAHc8Wvb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.47.2/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.47.2/index.min.mjs": "sha384-eMi8OLwFpGrgtkduT+lYkI2Jfci1BtcHk+3F5s69AsT0OpJ+rphWpMSiMAHc8Wvb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.47.2/LICENSE
```

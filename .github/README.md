...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.79.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.79.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0wuggVGnRQyGvu9AQeAgnfBDY1ipCrWrqRgxQaHxY/E+Cl+58wJ2ZciPDhimjT8J
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.79.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.79.0/index.min.mjs": "sha384-0wuggVGnRQyGvu9AQeAgnfBDY1ipCrWrqRgxQaHxY/E+Cl+58wJ2ZciPDhimjT8J"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.79.0/LICENSE
```

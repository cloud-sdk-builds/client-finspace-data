...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.621.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.621.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-N02Doa9Nx4Ictatlnywo9kQW5IT2aQdzUl3yz2A07y0uwX7H2/5pMIUFmp0HBLh+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.621.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.621.0/index.min.mjs": "sha384-N02Doa9Nx4Ictatlnywo9kQW5IT2aQdzUl3yz2A07y0uwX7H2/5pMIUFmp0HBLh+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.621.0/LICENSE
```

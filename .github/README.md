...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.726.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.726.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-JZvX2JhevfAvNQZJLkz0CO1cda5G8hcugjIFuEy0ZGRxPNaUc1HvZx1oi5Y+oqDx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.726.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.726.1/index.min.mjs": "sha384-JZvX2JhevfAvNQZJLkz0CO1cda5G8hcugjIFuEy0ZGRxPNaUc1HvZx1oi5Y+oqDx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.726.1/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.215.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.215.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-h1MaFAL3ADspFBRgUaDlWB2EvFN91rtTHSb4qBUimxJ4mjVpq7E9Jmh3ivyW8QmX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.215.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.215.0/index.min.mjs": "sha384-h1MaFAL3ADspFBRgUaDlWB2EvFN91rtTHSb4qBUimxJ4mjVpq7E9Jmh3ivyW8QmX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.215.0/LICENSE
```

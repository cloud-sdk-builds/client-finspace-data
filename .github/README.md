...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.523.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.523.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dYeWNe87T/7d+GMzUVa13AUS4Ua7aU/xQJx4ePFXNYGuAiGTKuEoV1u0AxwSsqbm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.523.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.523.0/index.min.mjs": "sha384-dYeWNe87T/7d+GMzUVa13AUS4Ua7aU/xQJx4ePFXNYGuAiGTKuEoV1u0AxwSsqbm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.523.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.931.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.931.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cPY0wflVndGS4+4lJ6PEt+QSue1UaxDfBwIkKWo5f+MxxYBwUZJio7O7vvfLAAcN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.931.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.931.0/index.min.mjs": "sha384-cPY0wflVndGS4+4lJ6PEt+QSue1UaxDfBwIkKWo5f+MxxYBwUZJio7O7vvfLAAcN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.931.0/LICENSE
```

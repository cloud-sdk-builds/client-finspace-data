...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.574.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.574.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dLAqb8Se/CBQ7qgE9g+PkeqhNUFW+uz96SW4rBdNHo6cjjG1GUQtLIaRMF8YUorT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.574.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.574.0/index.min.mjs": "sha384-dLAqb8Se/CBQ7qgE9g+PkeqhNUFW+uz96SW4rBdNHo6cjjG1GUQtLIaRMF8YUorT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.574.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.160.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.160.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UpfOCEk7NCxwH0qeuix6Xt6dyq+EHc95f9sqQg6n7stqqIX8po0MpMN8NfAwGyO2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.160.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.160.0/index.min.mjs": "sha384-UpfOCEk7NCxwH0qeuix6Xt6dyq+EHc95f9sqQg6n7stqqIX8po0MpMN8NfAwGyO2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.160.0/LICENSE
```

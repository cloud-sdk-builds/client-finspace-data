...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.345.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.345.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LTjl+6eOJjiX58Hzz8hFAen1nq+4Awp6g8N3PpVNx3lWFgAlCh8qiuFSKl/PDPtQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.345.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.345.0/index.min.mjs": "sha384-LTjl+6eOJjiX58Hzz8hFAen1nq+4Awp6g8N3PpVNx3lWFgAlCh8qiuFSKl/PDPtQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.345.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.296.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.296.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-VXiGG2b+z6ABFZ7FvTyVCcNeNpmXApi/LEHZeFBQR/OlhKe9MOFdUxQWntsDrHoD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.296.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.296.0/index.min.mjs": "sha384-VXiGG2b+z6ABFZ7FvTyVCcNeNpmXApi/LEHZeFBQR/OlhKe9MOFdUxQWntsDrHoD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.296.0/LICENSE
```

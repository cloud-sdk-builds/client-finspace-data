...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.716.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.716.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ifINCvy0KYMFQnbZclycydWpziHUINmMJEndGE3OhE6eduU/nL5df/gd/n19qtLW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.716.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.716.0/index.min.mjs": "sha384-ifINCvy0KYMFQnbZclycydWpziHUINmMJEndGE3OhE6eduU/nL5df/gd/n19qtLW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.716.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.576.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.576.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WtMz9Kwds61mPg97n1doZt1xKznNeWqgYNTOz8qrp9vIGIatMwUpkJJoA7xdlFpf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.576.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.576.0/index.min.mjs": "sha384-WtMz9Kwds61mPg97n1doZt1xKznNeWqgYNTOz8qrp9vIGIatMwUpkJJoA7xdlFpf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.576.0/LICENSE
```

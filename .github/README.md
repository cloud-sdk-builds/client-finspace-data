...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.468.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.468.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0ANEWUpF/Ie9igEfaRopfQ6wJxLccVWFK9G+lp96VVJLIDuFg/PGia1lv85W+1TK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.468.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.468.0/index.min.mjs": "sha384-0ANEWUpF/Ie9igEfaRopfQ6wJxLccVWFK9G+lp96VVJLIDuFg/PGia1lv85W+1TK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.468.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.26.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.26.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uh/z7ZNiDE9hUgzKBv6ypQBBU3rHZ65ol2jHv9mw5Nt3GeyUFXl0c1xzSigVqBpA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.26.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.26.0/index.min.mjs": "sha384-uh/z7ZNiDE9hUgzKBv6ypQBBU3rHZ65ol2jHv9mw5Nt3GeyUFXl0c1xzSigVqBpA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.26.0/LICENSE
```

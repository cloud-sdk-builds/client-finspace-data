...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.224.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.224.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FG2iIy8+AiqoXvZHxY8CEiqZ6y1nLSnVp9lZ20c/z4wePTsq5L+ab2IwJhPOwNK9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.224.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.224.0/index.min.mjs": "sha384-FG2iIy8+AiqoXvZHxY8CEiqZ6y1nLSnVp9lZ20c/z4wePTsq5L+ab2IwJhPOwNK9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.224.0/LICENSE
```

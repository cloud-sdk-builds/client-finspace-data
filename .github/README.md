...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.454.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.454.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-F3+o08RP/Zr5IlgdHaRxXlVpt9zfV+nKlVxPRfDHzuwvmNIWPLbadPnzN52wL9PP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.454.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.454.0/index.min.mjs": "sha384-F3+o08RP/Zr5IlgdHaRxXlVpt9zfV+nKlVxPRfDHzuwvmNIWPLbadPnzN52wL9PP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.454.0/LICENSE
```

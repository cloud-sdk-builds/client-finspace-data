...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.893.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.893.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uuZGHxMl7yZVyEADO+lnhpzTPf0nZ7ULg3O0+aAiVsYYiI0ubcBe0NIcFUeX9Ok1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.893.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.893.0/index.min.mjs": "sha384-uuZGHxMl7yZVyEADO+lnhpzTPf0nZ7ULg3O0+aAiVsYYiI0ubcBe0NIcFUeX9Ok1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.893.0/LICENSE
```

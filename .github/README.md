...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.25.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.25.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IpHtRAiTa6mHd9dygmBElDKQjekgP3OLU9CDZTIWOmRghHQjm+OQ4vaY5+H7sqgh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.25.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.25.0/index.min.mjs": "sha384-IpHtRAiTa6mHd9dygmBElDKQjekgP3OLU9CDZTIWOmRghHQjm+OQ4vaY5+H7sqgh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.25.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.353.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.353.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dFv/hESr1MTkr4e4ltvxdcutiR1ayICFiF4qckK5PblKGrrPLn3tKi8CkR8L9Xbb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.353.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.353.0/index.min.mjs": "sha384-dFv/hESr1MTkr4e4ltvxdcutiR1ayICFiF4qckK5PblKGrrPLn3tKi8CkR8L9Xbb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.353.0/LICENSE
```

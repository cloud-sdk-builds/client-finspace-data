...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.36.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.36.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZY4QEW3Lsrs4uPKXrIy2MiWpQN/qKQ7ZgPjLc5+sdfvj6mX5HoWJCbqcJKLnKIj7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.36.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.36.1/index.min.mjs": "sha384-ZY4QEW3Lsrs4uPKXrIy2MiWpQN/qKQ7ZgPjLc5+sdfvj6mX5HoWJCbqcJKLnKIj7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.36.1/LICENSE
```

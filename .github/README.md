...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.991.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.991.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IndMCi81iJKqbsDubd87HglXmP8MWF8LxOatuP/91zjy6dugHac4q+coDs3eC4oe
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.991.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.991.0/index.min.mjs": "sha384-IndMCi81iJKqbsDubd87HglXmP8MWF8LxOatuP/91zjy6dugHac4q+coDs3eC4oe"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.991.0/LICENSE
```

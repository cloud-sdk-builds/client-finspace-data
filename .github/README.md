...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.823.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.823.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/0cqsjYupp3MR6VDB77cxQILGL7dNXRZuLgl61gU7y+WNFLW/m9QSxvHU5IPP7FX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.823.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.823.0/index.min.mjs": "sha384-/0cqsjYupp3MR6VDB77cxQILGL7dNXRZuLgl61gU7y+WNFLW/m9QSxvHU5IPP7FX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.823.0/LICENSE
```

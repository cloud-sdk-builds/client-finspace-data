...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.437.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.437.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3F4+7iVKxXrN+giyNB+nR3A/qVhXeYGyu7zo0BfW2B/gjxDexhe2dJwcHes1HtjR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.437.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.437.0/index.min.mjs": "sha384-3F4+7iVKxXrN+giyNB+nR3A/qVhXeYGyu7zo0BfW2B/gjxDexhe2dJwcHes1HtjR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.437.0/LICENSE
```

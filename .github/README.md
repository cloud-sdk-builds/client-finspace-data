...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.799.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.799.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6wrt4uj7n++aMnr6YmEJIJ65QoTGRDl0XwVKI9ohrjYzjQ9/81kPnqMI6/2hn6sW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.799.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.799.0/index.min.mjs": "sha384-6wrt4uj7n++aMnr6YmEJIJ65QoTGRDl0XwVKI9ohrjYzjQ9/81kPnqMI6/2hn6sW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.799.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.572.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.572.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PvmQXuAonLz6H93MaUoQE8fzr+Pe293xFQddfbL8dMQ0i7c972+p1k5lwXW+MSPK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.572.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.572.0/index.min.mjs": "sha384-PvmQXuAonLz6H93MaUoQE8fzr+Pe293xFQddfbL8dMQ0i7c972+p1k5lwXW+MSPK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.572.0/LICENSE
```

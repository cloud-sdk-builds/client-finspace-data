...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.267.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.267.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xGsnnwmP/1Sdxq/TSeMRN+RbYLo+K9o2hqleopytRiErGwGub2aAhq1/zKzbAbMx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.267.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.267.0/index.min.mjs": "sha384-xGsnnwmP/1Sdxq/TSeMRN+RbYLo+K9o2hqleopytRiErGwGub2aAhq1/zKzbAbMx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.267.0/LICENSE
```

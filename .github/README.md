...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.916.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.916.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oGumGH9Sl/KjtpDI1nxt3VkRu3NWUT0NYJBmNkrDzy5KjxW7Xbklc+JE73hPW3Iy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.916.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.916.0/index.min.mjs": "sha384-oGumGH9Sl/KjtpDI1nxt3VkRu3NWUT0NYJBmNkrDzy5KjxW7Xbklc+JE73hPW3Iy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.916.0/LICENSE
```

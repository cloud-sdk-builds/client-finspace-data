...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.212.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.212.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qrt8X1fmQkx+3yI5TqU6LcYAkZSMtWt0sY7QcrzkDhSuor7b9w1wP9rgad2nP+Da
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.212.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.212.0/index.min.mjs": "sha384-qrt8X1fmQkx+3yI5TqU6LcYAkZSMtWt0sY7QcrzkDhSuor7b9w1wP9rgad2nP+Da"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.212.0/LICENSE
```

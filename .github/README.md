...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.670.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.670.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-U6JdYHcHGBReBDTeMJ67VypdVQ9+f+QYoxQc/natgrp0Z1U8MtmdLIgWtc3TcpwL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.670.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.670.0/index.min.mjs": "sha384-U6JdYHcHGBReBDTeMJ67VypdVQ9+f+QYoxQc/natgrp0Z1U8MtmdLIgWtc3TcpwL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.670.0/LICENSE
```

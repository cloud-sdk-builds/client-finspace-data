...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.1041.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1041.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xNOqAywySo2OgFlLpVHHYYmuXXr25AELc6Ts8yw350Qx58kO1y6Iw2JLlulNJlBh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1041.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1041.0/index.min.mjs": "sha384-xNOqAywySo2OgFlLpVHHYYmuXXr25AELc6Ts8yw350Qx58kO1y6Iw2JLlulNJlBh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.1041.0/LICENSE
```

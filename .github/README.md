...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.262.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.262.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aUgcL7YG5tPi4T4pqqnJCs7Ruf7OKteHBY9sbjkbXWnX3qZ1OhbfrL5PilAMkWxp
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.262.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.262.0/index.min.mjs": "sha384-aUgcL7YG5tPi4T4pqqnJCs7Ruf7OKteHBY9sbjkbXWnX3qZ1OhbfrL5PilAMkWxp"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.262.0/LICENSE
```

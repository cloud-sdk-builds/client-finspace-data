...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.78.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.78.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0a9dqNFqMMTK20Pcz2VKY7WUmdJhq8dhvtsn9wwnsoXlcaAYtF42fKjAEKOLgkjf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.78.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.78.0/index.min.mjs": "sha384-0a9dqNFqMMTK20Pcz2VKY7WUmdJhq8dhvtsn9wwnsoXlcaAYtF42fKjAEKOLgkjf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.78.0/LICENSE
```

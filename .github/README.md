...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.130.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.130.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Xk0/xM3L74yRQ92otFWNwS9OkHIPADOgRxT8fTTeLCz1ebTAdGgsN4S6EAnT1vhf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.130.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.130.0/index.min.mjs": "sha384-Xk0/xM3L74yRQ92otFWNwS9OkHIPADOgRxT8fTTeLCz1ebTAdGgsN4S6EAnT1vhf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.130.0/LICENSE
```

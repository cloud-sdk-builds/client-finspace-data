...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.271.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.271.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-C3alnuWUYC3cBgafTAEvzYitUkba+W58J4oWZwFDKFkcX04pfWxbVlLH2Jyai/te
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.271.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.271.0/index.min.mjs": "sha384-C3alnuWUYC3cBgafTAEvzYitUkba+W58J4oWZwFDKFkcX04pfWxbVlLH2Jyai/te"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.271.0/LICENSE
```

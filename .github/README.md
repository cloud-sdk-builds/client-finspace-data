...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.94.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.94.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6gdv7J32wUD79UpdLrjwVqZKmMxE0WccJ49Po1SdbWCdGQzwQEgq6hnYpY953hmP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.94.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.94.0/index.min.mjs": "sha384-6gdv7J32wUD79UpdLrjwVqZKmMxE0WccJ49Po1SdbWCdGQzwQEgq6hnYpY953hmP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.94.0/LICENSE
```

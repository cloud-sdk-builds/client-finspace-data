...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.691.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.691.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7VVPpirTzQ1Vd69Kd1ZFbrTzFDxCVmaTVD05JhFOCISEIH0pXUgCzUNH3s33Uwyi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.691.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.691.0/index.min.mjs": "sha384-7VVPpirTzQ1Vd69Kd1ZFbrTzFDxCVmaTVD05JhFOCISEIH0pXUgCzUNH3s33Uwyi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.691.0/LICENSE
```

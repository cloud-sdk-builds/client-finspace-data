...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.363.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.363.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aQJ1e2g95Foh3D2OrbyBpqgNyPV2JGTIOZn8+A27A6p22a3pcZCinhIsyhb9AVBo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.363.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.363.0/index.min.mjs": "sha384-aQJ1e2g95Foh3D2OrbyBpqgNyPV2JGTIOZn8+A27A6p22a3pcZCinhIsyhb9AVBo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.363.0/LICENSE
```

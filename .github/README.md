...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.936.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.936.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9fLoWRYsHeJWW2sS0rTRo1zKwfoKR4Rd0tri13PdPAm03v3Lm/jC1DojlvtuaD/s
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.936.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.936.0/index.min.mjs": "sha384-9fLoWRYsHeJWW2sS0rTRo1zKwfoKR4Rd0tri13PdPAm03v3Lm/jC1DojlvtuaD/s"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.936.0/LICENSE
```

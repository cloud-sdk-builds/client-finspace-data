...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.782.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.782.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-stAY/K3SngUCHzDXvcNfANKIE5ZR0ewVmBbD7z3YKdCxb0AfMe4nc5Xv1Asjlx5P
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.782.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.782.0/index.min.mjs": "sha384-stAY/K3SngUCHzDXvcNfANKIE5ZR0ewVmBbD7z3YKdCxb0AfMe4nc5Xv1Asjlx5P"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.782.0/LICENSE
```

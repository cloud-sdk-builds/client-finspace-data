...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.667.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.667.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dYohYHF/gW/Tr7DOLYF07u8lEJkVoG0gB2mwWkUM5CZPfwVlPE/uf2CMmQoe2AoB
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.667.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.667.0/index.min.mjs": "sha384-dYohYHF/gW/Tr7DOLYF07u8lEJkVoG0gB2mwWkUM5CZPfwVlPE/uf2CMmQoe2AoB"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.667.0/LICENSE
```

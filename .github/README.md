...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.583.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.583.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vQb+tnHoKonJJOKZOgn+I0SgjMULZD7RXQ7X3XaQD5aqPmRGvESqVUDqlQcRbefA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.583.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.583.0/index.min.mjs": "sha384-vQb+tnHoKonJJOKZOgn+I0SgjMULZD7RXQ7X3XaQD5aqPmRGvESqVUDqlQcRbefA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.583.0/LICENSE
```

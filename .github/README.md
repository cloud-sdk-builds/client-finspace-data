...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.436.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.436.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qKRN7DMOaiNUcLb0AsDL0hMmuPvg+hup9KH/V9fDALFzHqsaG3RMjMTVAYaTj56/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.436.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.436.0/index.min.mjs": "sha384-qKRN7DMOaiNUcLb0AsDL0hMmuPvg+hup9KH/V9fDALFzHqsaG3RMjMTVAYaTj56/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.436.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.962.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.962.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lDOvlz9r8+tpR4akWMyFgU/z0J2rmOYNMBlNFRfs0Yz+whUPuZqU0QTw2tRkC9h/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.962.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.962.0/index.min.mjs": "sha384-lDOvlz9r8+tpR4akWMyFgU/z0J2rmOYNMBlNFRfs0Yz+whUPuZqU0QTw2tRkC9h/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.962.0/LICENSE
```

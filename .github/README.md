...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.222.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.222.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ndMMEdTbpm28UXWWZ91fCBQp+8dDoaf5rz3JN/Mvkb+RkAyE8BhDTPKAplBj2WvP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.222.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.222.0/index.min.mjs": "sha384-ndMMEdTbpm28UXWWZ91fCBQp+8dDoaf5rz3JN/Mvkb+RkAyE8BhDTPKAplBj2WvP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.222.0/LICENSE
```

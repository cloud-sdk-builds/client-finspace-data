...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.692.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.692.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RLLIc23l8YqcPrC8BCx391QeUKA2DCE7019VK1bNM2PLdVCWFUqJtgfM7KtKbP4Y
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.692.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.692.0/index.min.mjs": "sha384-RLLIc23l8YqcPrC8BCx391QeUKA2DCE7019VK1bNM2PLdVCWFUqJtgfM7KtKbP4Y"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.692.0/LICENSE
```

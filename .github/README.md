...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.299.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.299.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AiUOg5+kS2y5GgJUPY3CUF8BaM6GjhvymWVnzaIxgOe1VNLKvXxuHV2/4V7GiBvh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.299.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.299.0/index.min.mjs": "sha384-AiUOg5+kS2y5GgJUPY3CUF8BaM6GjhvymWVnzaIxgOe1VNLKvXxuHV2/4V7GiBvh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.299.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.772.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.772.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-psU5QqHfl10BaTC6wkk27fs+IerKLE+gQfbELWXi+prbnY+0+b5GrAXYw9tkYHnm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.772.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.772.0/index.min.mjs": "sha384-psU5QqHfl10BaTC6wkk27fs+IerKLE+gQfbELWXi+prbnY+0+b5GrAXYw9tkYHnm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.772.0/LICENSE
```

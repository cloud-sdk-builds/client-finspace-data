...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.613.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.613.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nha3BfXgFRc1113JCEAwZDZWlO1TYpmww+ifz0G/9STs/zWi2T4phyQ5VJSSqc89
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.613.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.613.0/index.min.mjs": "sha384-nha3BfXgFRc1113JCEAwZDZWlO1TYpmww+ifz0G/9STs/zWi2T4phyQ5VJSSqc89"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.613.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.658.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.658.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-s2y0g//C2OKUR3Kei49KL1RvxVYcinB+0NjryBTEqDdJMBkkcIU/RaRkDB08XMjz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.658.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.658.1/index.min.mjs": "sha384-s2y0g//C2OKUR3Kei49KL1RvxVYcinB+0NjryBTEqDdJMBkkcIU/RaRkDB08XMjz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.658.1/LICENSE
```

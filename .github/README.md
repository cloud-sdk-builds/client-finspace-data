...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.53.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.53.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-e4XEq8GTmbEB9ONTfkzuCprlSudWx43S4wmRDCtRXlqenS9kUXQzNdfJ0ou6SKx/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.53.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.53.0/index.min.mjs": "sha384-e4XEq8GTmbEB9ONTfkzuCprlSudWx43S4wmRDCtRXlqenS9kUXQzNdfJ0ou6SKx/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.53.0/LICENSE
```

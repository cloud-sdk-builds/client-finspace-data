...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.168.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.168.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1WPH6FuI6yHbsm9DjY/yptwYZoDJvu2UW7YIRdl5ULpM2UkVCzDJpdf9jrneQjF+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.168.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.168.0/index.min.mjs": "sha384-1WPH6FuI6yHbsm9DjY/yptwYZoDJvu2UW7YIRdl5ULpM2UkVCzDJpdf9jrneQjF+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.168.0/LICENSE
```

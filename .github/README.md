...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.326.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.326.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1CgZSEKXKvWEGoM1RlKWyTQdkVyjQh1t2V32egORI+JLO/DMxtXgkQzE0hlQPLCJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.326.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.326.0/index.min.mjs": "sha384-1CgZSEKXKvWEGoM1RlKWyTQdkVyjQh1t2V32egORI+JLO/DMxtXgkQzE0hlQPLCJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.326.0/LICENSE
```

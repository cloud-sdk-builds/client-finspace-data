...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.45.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.45.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SYXVObL8tZQS1f1+A4SRS4qwtOLmqd+Ms6fRklDu1A840yx/CYRcWHd6sJAx47UQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.45.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.45.0/index.min.mjs": "sha384-SYXVObL8tZQS1f1+A4SRS4qwtOLmqd+Ms6fRklDu1A840yx/CYRcWHd6sJAx47UQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.45.0/LICENSE
```

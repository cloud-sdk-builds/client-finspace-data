...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.1023.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1023.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OJo0vSHQz3BGhupRBm7//cXiTrtEZFfreLn6evQRhDcjp5YYgiwHYY4efVG+3nAW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1023.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1023.0/index.min.mjs": "sha384-OJo0vSHQz3BGhupRBm7//cXiTrtEZFfreLn6evQRhDcjp5YYgiwHYY4efVG+3nAW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.1023.0/LICENSE
```

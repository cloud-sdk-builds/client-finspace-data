...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.587.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.587.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GW8HkulqhMvH8JxGEXK5NsgCdcnDs6F9kjI0ApfwkNaKVHVP01dcF6oZQMvPuPnl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.587.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.587.0/index.min.mjs": "sha384-GW8HkulqhMvH8JxGEXK5NsgCdcnDs6F9kjI0ApfwkNaKVHVP01dcF6oZQMvPuPnl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.587.0/LICENSE
```

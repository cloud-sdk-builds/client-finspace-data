...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.1031.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1031.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4v3OMXdrD+5wT0crfrSe/W1Q6GXz7pyvhCa9LCX1Eg6TTulgUVMKaTbXcszNV4K0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1031.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.1031.0/index.min.mjs": "sha384-4v3OMXdrD+5wT0crfrSe/W1Q6GXz7pyvhCa9LCX1Eg6TTulgUVMKaTbXcszNV4K0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.1031.0/LICENSE
```

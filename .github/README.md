...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.649.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.649.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-RWYn59c5Wsn8U/VbaPcMA7gqE4NzRjknf4IGPntn5h+gNRYW0MJuq5Dw+E8vNc+k
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.649.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.649.0/index.min.mjs": "sha384-RWYn59c5Wsn8U/VbaPcMA7gqE4NzRjknf4IGPntn5h+gNRYW0MJuq5Dw+E8vNc+k"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.649.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.315.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.315.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4pop77SyFXlzviFJT7DzLS9LTiLPSez56Im5C2ON73ZgZd/2f6/ya9NOj1n1Ymey
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.315.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.315.0/index.min.mjs": "sha384-4pop77SyFXlzviFJT7DzLS9LTiLPSez56Im5C2ON73ZgZd/2f6/ya9NOj1n1Ymey"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.315.0/LICENSE
```

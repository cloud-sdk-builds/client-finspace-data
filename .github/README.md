...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.721.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.721.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zGjv/3mi3VpWJ0fSTJLV5uNbivZ/gFSFNTxENNdr30v8amo4taOb8DfPwccyKxvI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.721.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.721.0/index.min.mjs": "sha384-zGjv/3mi3VpWJ0fSTJLV5uNbivZ/gFSFNTxENNdr30v8amo4taOb8DfPwccyKxvI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.721.0/LICENSE
```

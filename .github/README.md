...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.525.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.525.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-EgY3eNbe4LOYtjJc6NqGpTccFM5d2ytkIr6D+XY7zmWEEVwhYJAV4gDBU+O1yAh3
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.525.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.525.0/index.min.mjs": "sha384-EgY3eNbe4LOYtjJc6NqGpTccFM5d2ytkIr6D+XY7zmWEEVwhYJAV4gDBU+O1yAh3"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.525.0/LICENSE
```

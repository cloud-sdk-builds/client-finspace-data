...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.787.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.787.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-OJn8WeJAArWOWSKgmdT77ZRoTo2SuSvzWTU6h2BvDF9Rg7CA7WByOFyskQt+v9eH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.787.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.787.0/index.min.mjs": "sha384-OJn8WeJAArWOWSKgmdT77ZRoTo2SuSvzWTU6h2BvDF9Rg7CA7WByOFyskQt+v9eH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.787.0/LICENSE
```

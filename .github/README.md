...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.922.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.922.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-1dlXs4NhDg2SYmz9Eoo71F/txFgt5PpwRsb9SDq8/gGbUmqLWZ7vVBtll1dmCn/v
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.922.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.922.0/index.min.mjs": "sha384-1dlXs4NhDg2SYmz9Eoo71F/txFgt5PpwRsb9SDq8/gGbUmqLWZ7vVBtll1dmCn/v"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.922.0/LICENSE
```

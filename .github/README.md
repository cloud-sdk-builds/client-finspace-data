...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.894.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.894.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-24fOweHRHKbqmOMrDDs4nrJIDIQNt7hy1rbS2RXwXHY1I8mLxLN2HWL88vxX1bcC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.894.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.894.0/index.min.mjs": "sha384-24fOweHRHKbqmOMrDDs4nrJIDIQNt7hy1rbS2RXwXHY1I8mLxLN2HWL88vxX1bcC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.894.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.43.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.43.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-fIs8rWPqXYIlEuHdNwULElxI2yGYZ6dJMqAd54n+zS/oOVO7xAdmDPz4GfjJH+8D
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.43.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.43.0/index.min.mjs": "sha384-fIs8rWPqXYIlEuHdNwULElxI2yGYZ6dJMqAd54n+zS/oOVO7xAdmDPz4GfjJH+8D"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.43.0/LICENSE
```

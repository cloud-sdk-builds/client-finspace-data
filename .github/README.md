...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.731.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.731.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qZ7HFgCsGcrBgoTKvhR4Dz2lthIdNkVZzsVqeUqAx9iLhuB+TSyzytGXosb1+c2z
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.731.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.731.0/index.min.mjs": "sha384-qZ7HFgCsGcrBgoTKvhR4Dz2lthIdNkVZzsVqeUqAx9iLhuB+TSyzytGXosb1+c2z"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.731.0/LICENSE
```

...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.28.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.28.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4Xfca0gubZ2vZEorMTJW1U5Qk5baER4cw4cM56P2HA+JCd5IeAAEAnQHDS6+D6Sl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.28.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.28.0/index.min.mjs": "sha384-4Xfca0gubZ2vZEorMTJW1U5Qk5baER4cw4cM56P2HA+JCd5IeAAEAnQHDS6+D6Sl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.28.0/LICENSE
```

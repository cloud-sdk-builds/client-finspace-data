...
[`@aws-sdk/client-finspace-data`](https://www.npmjs.com/package/@aws-sdk/client-finspace-data/v/3.864.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.864.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wrpO+8d8U7/4AfB8M9jc28TX3rTy6PMAAej+c8thzaX1XMwsqR0o7vQSQ8XjdA/t
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-finspace-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.864.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-finspace-data@3.864.0/index.min.mjs": "sha384-wrpO+8d8U7/4AfB8M9jc28TX3rTy6PMAAej+c8thzaX1XMwsqR0o7vQSQ8XjdA/t"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-finspace-data/blob/refs/tags/3.864.0/LICENSE
```
